        ...
        <div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="flex items-start gap-4">
                    ...
                    <div class="flex-1">
                        <h1 class="text-2xl font-bold text-primary-900 dark:text-primary-100 mb-2">
                            <?php echo e(__('data_export.page_title')); ?>

                        </h1>
                        <p class="text-primary-800 dark:text-primary-200 leading-relaxed">
                            <?php echo e(__('data_export.page_subtitle')); ?>
            ...
            <div class="bg-white dark:bg-neutral-900 rounded-xl shadow-lg border border-neutral-200 dark:border-neutral-800 overflow-hidden">
                ...
                <div class="p-6 md:p-8 border-b border-neutral-200 dark:border-neutral-800">
                    <h2 class="text-xl font-bold text-neutral-900 dark:text-white mb-4">
                        <?php echo e(__('data_export.what_included_title')); ?>
                    ...
                    <div class="grid sm:grid-cols-2 gap-4">
                        <div class="flex items-start gap-3 p-4 bg-neutral-50 dark:bg-neutral-800/50 rounded-lg">
                            ...
                            <div>
                                <h3 class="font-semibold text-neutral-900 dark:text-white">
                                    <?php echo e(__('data_export.personal_info')); ?>

                                </h3>
                                <p class="text-sm text-neutral-600 dark:text-neutral-400">
                                    <?php echo e(__('data_export.personal_info_desc')); ?>
                        ...
                        <div class="flex items-start gap-3 p-4 bg-neutral-50 dark:bg-neutral-800/50 rounded-lg">
                            ...
                            <div>
                                <h3 class="font-semibold text-neutral-900 dark:text-white">
                                    <?php echo e(__('data_export.content')); ?>

                                </h3>
                                <p class="text-sm text-neutral-600 dark:text-neutral-400">
                                    <?php echo e(__('data_export.content_desc')); ?>
                        ...
                        <div class="flex items-start gap-3 p-4 bg-neutral-50 dark:bg-neutral-800/50 rounded-lg">
                            ...
                            <div>
                                <h3 class="font-semibold text-neutral-900 dark:text-white">
                                    <?php echo e(__('data_export.interactions')); ?>

                                </h3>
                                <p class="text-sm text-neutral-600 dark:text-neutral-400">
                                    <?php echo e(__('data_export.interactions_desc')); ?>
                        ...
                        <div class="flex items-start gap-3 p-4 bg-neutral-50 dark:bg-neutral-800/50 rounded-lg">
                            ...
                            <div>
                                <h3 class="font-semibold text-neutral-900 dark:text-white">
                                    <?php echo e(__('data_export.privacy')); ?>

                                </h3>
                                <p class="text-sm text-neutral-600 dark:text-neutral-400">
                                    <?php echo e(__('data_export.privacy_desc')); ?>
                ...
                <div class="p-6 md:p-8 space-y-6">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!$exportReady): ?>
                        <div class="text-center py-8">
                            ...
                            <h3 class="text-lg font-bold text-neutral-900 dark:text-white mb-2">
                                <?php echo e(__('data_export.ready_title')); ?>

                            </h3>
                            <p class="text-neutral-600 dark:text-neutral-400 mb-6">
                                <?php echo e(__('data_export.ready_description')); ?>
                            ...
                            >
                                ...
                                <span wire:loading.remove><?php echo e(__('data_export.generate_button')); ?></span>
                                <span wire:loading><?php echo e(__('data_export.generating')); ?></span>
                            </button>
                        </div>
                    <?php else: ?>
                        <div class="text-center py-8">
                            ...
                            <h3 class="text-lg font-bold text-neutral-900 dark:text-white mb-2">
                                <?php echo e(__('data_export.ready_download_title')); ?>

                            </h3>
                            <p class="text-neutral-600 dark:text-neutral-400 mb-6">
                                <?php echo e(__('data_export.ready_download_description')); ?>

                            </p>
                            
                            <a 
                                href="<?php echo e(route('profile.export.download')); ?>"
                            ...
                            >
                                ...
                                <?php echo e(__('data_export.download_button')); ?>
                            ...
                            <div class="mt-4">
                                ...
                                >
                                    <?php echo e(__('data_export.generate_new')); ?>
                    ...
                    <div class="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-4">
                        <div class="flex gap-3">
                            ...
                            <div class="text-sm text-blue-800 dark:text-blue-200">
                                <p class="font-semibold mb-1"><?php echo e(__('data_export.info_title')); ?></p>
                                <p><?php echo e(__('data_export.info_description')); ?></p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="text-center">
                        ...
                        >
                            ...
                            <?php echo e(__('data_export.back_to_settings')); ?>
            ...
            <div class="mt-6 text-center">
                <p class="text-xs text-neutral-500 dark:text-neutral-400">
                    <?php echo e(__('data_export.gdpr_note')); ?>
