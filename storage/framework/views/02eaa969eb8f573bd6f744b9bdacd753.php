<div class="p-6 max-w-7xl mx-auto">
    ...
    <div class="mb-8">
        <h1 class="text-4xl font-black text-neutral-900 dark:text-white mb-2" style="font-family: 'Crimson Pro', serif;">
            <?php echo e(__('admin.translations.title')); ?>

        </h1>
        <p class="text-lg text-neutral-600 dark:text-neutral-400"><?php echo e(__('admin.translations.description')); ?></p>
    </div>
    ...
    <div class="bg-white dark:bg-neutral-800 rounded-2xl shadow-lg p-6 mb-6">
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-4">
            ...
            <div>
                <label class="block text-sm font-bold text-neutral-700 dark:text-neutral-300 mb-2">
                    <?php echo e(__('admin.translations.select_language')); ?>
                ...
                <select wire:model.live="selectedLanguage" 
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $this->languages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lang): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <div>
                <label class="block text-sm font-bold text-neutral-700 dark:text-neutral-300 mb-2">
                    <?php echo e(__('admin.translations.select_file')); ?>

                </label>
                <select wire:model.live="selectedFile" 
                        class="w-full px-4 py-3 rounded-xl border-2 border-neutral-300 dark:border-neutral-600 bg-white dark:bg-neutral-900 text-neutral-900 dark:text-white font-medium focus:ring-2 focus:ring-primary-500 focus:border-transparent">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $this->translationFiles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $fileKey => $fileDisplayName): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($fileKey); ?>"><?php echo e($fileDisplayName); ?></option>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                </select>
            </div>
        ...
        <div class="flex flex-wrap gap-3">
            <button wire:click="$toggle('showCreateLanguageModal')" 
                ...
                ➕ <?php echo e(__('admin.translations.add_language')); ?>

            </button>
            <button wire:click="syncLanguage('<?php echo e($selectedLanguage); ?>')" 
                    class="px-5 py-2.5 bg-neutral-600 hover:bg-neutral-700 text-white font-bold rounded-xl transition-colors">
                🔄 <?php echo e(__('admin.translations.sync')); ?>
            ...
            <button wire:click="$toggle('showImportModal')" 
                ...
                📤 <?php echo e(__('admin.translations.import')); ?>
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($this->languageStats[$selectedLanguage])): ?>
        <?php $stats = $this->languageStats[$selectedLanguage]; ?>
        <div class="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
            <div class="bg-gradient-to-br from-blue-50 to-blue-100 dark:from-blue-900/20 dark:to-blue-800/20 rounded-2xl p-6 border-2 border-blue-200 dark:border-blue-800">
                <h3 class="text-sm font-bold text-blue-600 dark:text-blue-400 mb-2"><?php echo e(__('admin.translations.total_keys')); ?></h3>
                <p class="text-4xl font-black text-blue-900 dark:text-blue-100"><?php echo e($stats['total_keys']); ?></p>
            </div>
            <div class="bg-gradient-to-br from-green-50 to-green-100 dark:from-green-900/20 dark:to-green-800/20 rounded-2xl p-6 border-2 border-green-200 dark:border-green-800">
                <h3 class="text-sm font-bold text-green-600 dark:text-green-400 mb-2"><?php echo e(__('admin.translations.translated_keys')); ?></h3>
                <p class="text-4xl font-black text-green-900 dark:text-green-100"><?php echo e($stats['translated_keys']); ?></p>
            </div>
            <div class="bg-gradient-to-br from-red-50 to-red-100 dark:from-red-900/20 dark:to-red-800/20 rounded-2xl p-6 border-2 border-red-200 dark:border-red-800">
                <h3 class="text-sm font-bold text-red-600 dark:text-red-400 mb-2"><?php echo e(__('admin.translations.missing_keys')); ?></h3>
                <p class="text-4xl font-black text-red-900 dark:text-red-100"><?php echo e($stats['missing_keys']); ?></p>
            </div>
            <div class="bg-gradient-to-br from-primary-50 to-primary-100 dark:from-primary-900/20 dark:to-primary-800/20 rounded-2xl p-6 border-2 border-primary-200 dark:border-primary-800">
                <h3 class="text-sm font-bold text-primary-600 dark:text-primary-400 mb-2"><?php echo e(__('admin.translations.progress')); ?></h3>
                <p class="text-4xl font-black text-primary-900 dark:text-primary-100"><?php echo e($stats['progress_percentage']); ?>%</p>
            </div>
        </div>
    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
    ...
    <div class="space-y-4">
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $paginated; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            <div class="bg-white dark:bg-neutral-800 rounded-2xl shadow-lg border-2 <?php echo e($data['is_missing'] ? 'border-red-200 dark:border-red-800 bg-red-50/50 dark:bg-red-900/10' : 'border-neutral-200 dark:border-neutral-700'); ?> p-6 hover:shadow-xl transition-all duration-300">
                <div class="flex items-start justify-between mb-4">
                    <div class="flex-1">
                        <div class="flex items-center gap-3 mb-2 flex-wrap">
                            <div class="flex items-center gap-2">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(str_contains($key, '.')): ?>
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(str_contains($key, '.')): ?>
                            <p class="text-xs text-neutral-500 dark:text-neutral-400 mt-1 italic">
                                Chiave annidata (<?php echo e(str_replace('.', ' → ', $key)); ?>)
                            </p>
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    </div>
                </div>
                ...
                <div class="mb-4">
                    ...
                    <div class="p-4 bg-neutral-50 dark:bg-neutral-900 rounded-xl border border-neutral-200 dark:border-neutral-700 min-h-[60px]">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($data['reference'])): ?>
                            <p class="text-neutral-700 dark:text-neutral-300 font-medium whitespace-pre-wrap"><?php echo e($data['reference']); ?></p>
                        <?php else: ?>
                ...
                <div>
                    <label class="block text-xs font-bold text-neutral-500 dark:text-neutral-400 mb-2 uppercase tracking-wide">
                        <?php echo e(strtoupper($selectedLanguage)); ?> - <?php echo e(__('admin.translations.translation')); ?>

                    </label>
                    
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($editingKey === $key): ?>
                    ...
                    <?php else: ?>
                        ...
                        <div class="space-y-3">
                            <div class="p-4 bg-neutral-50 dark:bg-neutral-900 rounded-xl border-2 border-neutral-200 dark:border-neutral-700 min-h-[100px]">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty(trim($data['translation']))): ?>
                                    <p class="text-neutral-700 dark:text-neutral-300 font-medium whitespace-pre-wrap"><?php echo e($data['translation']); ?></p>
                                <?php else: ?>
                                    <p class="text-neutral-400 dark:text-neutral-500 italic">⚠️ Nessuna traduzione - Clicca "Modifica" per aggiungerla</p>
                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            </div>
                            <button wire:click="startEditing('<?php echo e($key); ?>')" 
                                    class="px-5 py-2.5 bg-primary-600 hover:bg-primary-700 text-white font-bold rounded-xl transition-colors">
                                ✏️ <?php echo e(empty(trim($data['translation'])) ? 'Aggiungi Traduzione' : 'Modifica'); ?>
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(count($filtered) > $perPage): ?>
            <div class="mt-6 flex justify-center">
                <div class="flex gap-2">
                    ...
                    <div class="px-4 py-2 bg-primary-600 text-white font-bold rounded-xl">
                        Pagina <?php echo e($currentPage); ?> di <?php echo e(ceil(count($filtered) / $perPage)); ?>

                    </div>
                    
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($currentPage < ceil(count($filtered) / $perPage)): ?>
        ...
        <div class="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-50 p-4">
            <div class="bg-white dark:bg-neutral-800 rounded-3xl shadow-2xl p-8 max-w-md w-full">
                <h2 class="text-2xl font-black text-neutral-900 dark:text-white mb-6" style="font-family: 'Crimson Pro', serif;">
                    <?php echo e(__('admin.translations.import_translations')); ?>
...
$message = $__bag->first($__errorArgs[0]); ?> 
                            <span class="text-red-600 text-sm mt-2 block"><?php echo e($message); ?></span> 
                        <?php unset($message);
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($showCreateLanguageModal): ?>
        <div class="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-50 p-4">
            <div class="bg-white dark:bg-neutral-800 rounded-3xl shadow-2xl p-8 max-w-md w-full">
                <h2 class="text-2xl font-black text-neutral-900 dark:text-white mb-6" style="font-family: 'Crimson Pro', serif;">
                    <?php echo e(__('admin.translations.create_language')); ?>
                ...
                <div class="space-y-6">
                    <div>
                        <label class="block text-sm font-bold text-neutral-700 dark:text-neutral-300 mb-2">
                            <?php echo e(__('admin.translations.language_code')); ?>
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['newLanguageCode'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> 
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    ...
                    <div>
                        <label class="block text-sm font-bold text-neutral-700 dark:text-neutral-300 mb-2">
                            <?php echo e(__('admin.translations.language_name')); ?>

                        </label>
                        <input type="text" wire:model="newLanguageName" 
                               class="w-full px-4 py-3 rounded-xl border-2 border-neutral-300 dark:border-neutral-600 bg-white dark:bg-neutral-900 text-neutral-900 dark:text-white font-medium"
                               placeholder="English, Français, Español, etc.">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['newLanguageName'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> 
...
<?php /**PATH /Users/mazzi/slamin_v2/resources/views/livewire/admin/translations/translation-management.blade.php ENDPATH**/ ?>