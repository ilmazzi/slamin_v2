...
<article class="group bg-white dark:bg-neutral-800 rounded-xl shadow-md overflow-hidden hover:shadow-xl transition-all duration-300 flex flex-col h-full">
    ...
    <div class="p-6 flex-1 flex flex-col">
        <h3 class="<?php echo e($titleSize); ?> font-bold text-neutral-900 dark:text-white mb-3 group-hover:text-primary-600 dark:group-hover:text-primary-400 transition-colors line-clamp-2">
...
<?php /**PATH C:\xampp\htdocs\slamin_v2\resources\views/livewire/articles/article-card.blade.php ENDPATH**/ ?>