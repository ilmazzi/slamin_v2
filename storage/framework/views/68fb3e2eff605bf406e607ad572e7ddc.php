            ...
            <div class="text-center space-y-8">
                ...
                <div class="space-y-4">
                    <h1 class="text-5xl md:text-7xl font-bold text-white" style="font-family: 'Crimson Pro', serif;">
                        <?php echo e(__('home.hero_welcome')); ?> <span class="text-transparent bg-clip-text bg-gradient-to-r from-primary-400 to-primary-600"><?php echo e(config('app.name')); ?></span>
                    </h1>
                            ...
                            <div class="hero-magazine-cover" style="transform: rotate(<?php echo e($rotation); ?>deg);">
                                <div class="hero-magazine-inner">
                                    <div class="flex justify-between items-start mb-1">
                                        <div class="text-xs font-bold text-neutral-900"><?php echo e(strtoupper(config('app.name'))); ?></div>
                    ...
                    <div class="hero-card-container flex-shrink-0">
                        <div class="hero-film-wrapper cursor-pointer"
                            ...
                            <div class="hero-film-strip">
                                <!-- Film codes -->
                                <div class="hero-film-code-top"><?php echo e(strtoupper(config('app.name'))); ?></div>
...
[$__name, $__params] = $__split('home.hero-carousel', []);

$key = null;

$key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-1273157566-0', null);
...
[$__name, $__params] = $__split('home.videos-section', []);

$key = null;

$key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-1273157566-1', null);
...
[$__name, $__params] = $__split('home.events-slider', []);

$key = null;

$key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-1273157566-2', null);
...
[$__name, $__params] = $__split('home.completed-poetry-slams', []);

$key = null;

$key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-1273157566-3', null);
...
[$__name, $__params] = $__split('home.poetry-section', []);

$key = null;

$key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-1273157566-4', null);
...
[$__name, $__params] = $__split('home.new-users-section', []);

$key = null;

$key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-1273157566-5', null);
            ...
            <div>
                <div class="text-center mb-12 section-title-fade">
                    <h2 class="text-4xl md:text-5xl font-bold mb-3 text-neutral-900 dark:text-white" style="font-family: 'Crimson Pro', serif;">
                        <?php echo __('home.articles_section_title'); ?>

                    </h2>
                    <p class="text-lg text-neutral-800 dark:text-neutral-300 font-medium"><?php echo e(__('home.articles_section_subtitle')); ?></p>
                </div>
                <?php
$__split = function ($name, $params = []) {
    return [$name, $params];
};
[$__name, $__params] = $__split('home.articles-section', []);

$key = null;

$key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-1273157566-6', null);
...
?>
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!auth()->check() || !auth()->user()->hasRole('audience')): ?>
    <div class="py-20 md:py-24 cork-board-section">
        <?php
$__split = function ($name, $params = []) {
    return [$name, $params];
};
[$__name, $__params] = $__split('home.gigs-section', []);

$key = null;

$key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-1273157566-7', null);
...
[$__name, $__params] = $__split('home.statistics-section', []);

$key = null;

$key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-1273157566-8', null);
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->guard()->guest()): ?>
        <section class="relative py-24 md:py-32 overflow-hidden bg-gradient-to-br from-primary-600 via-primary-700 to-primary-800">
            ...
            <div class="relative z-10 max-w-4xl mx-auto px-4 md:px-6 text-center text-white">
                ...
                <?php if (isset($component)) { $__componentOriginala46fd1da0486e76cf404cb8e35cd6ddb = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginala46fd1da0486e76cf404cb8e35cd6ddb = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.ui.buttons.primary','data' => ['href' => ''.e(route('register')).'','size' => 'lg']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('ui.buttons.primary'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['href' => ''.e(route('register')).'','size' => 'lg']); ?>
                    <?php echo e(__('home.cta_button')); ?>

                 <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginala46fd1da0486e76cf404cb8e35cd6ddb)): ?>
<?php $attributes = $__attributesOriginala46fd1da0486e76cf404cb8e35cd6ddb; ?>
<?php unset($__attributesOriginala46fd1da0486e76cf404cb8e35cd6ddb); ?>
<?php endif; ?>
<?php if (isset($__componentOriginala46fd1da0486e76cf404cb8e35cd6ddb)): ?>
<?php $component = $__componentOriginala46fd1da0486e76cf404cb8e35cd6ddb; ?>
<?php unset($__componentOriginala46fd1da0486e76cf404cb8e35cd6ddb); ?>
<?php endif; ?>
            </div>
        </section>
    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
...
[$__name, $__params] = $__split('home.personalized-feed', []);

$key = null;

$key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-1273157566-9', null);
...
<?php /**PATH /Users/mazzi/slamin_v2/resources/views/livewire/home/home-index.blade.php ENDPATH**/ ?>