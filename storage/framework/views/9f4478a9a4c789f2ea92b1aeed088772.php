...
<div wire:poll.30s="pollForBadge">
    ...
    <div class="badge-notification-overlay" 
         x-data="{ show: <?php if ((object) ('showNotification') instanceof \Livewire\WireDirective) : ?>window.Livewire.find('<?php echo e($__livewire->getId()); ?>').entangle('<?php echo e('showNotification'->value()); ?>')<?php echo e('showNotification'->hasModifier('live') ? '.live' : ''); ?><?php else : ?>window.Livewire.find('<?php echo e($__livewire->getId()); ?>').entangle('<?php echo e('showNotification'); ?>')<?php endif; ?> }"
         x-show="show"
        ...
        <div class="badge-notification-content"
            ...
            <div class="confetti-container">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php for($i = 0; $i < 50; $i++): ?>
                <div class="confetti" style="
                    left: <?php echo e(rand(0, 100)); ?>%;
                    animation-delay: <?php echo e(rand(0, 300) / 100); ?>s;
                    background: <?php echo e(['#FFD700', '#FF6B6B', '#4ECDC4', '#45B7D1', '#FFA07A', '#98D8C8'][ rand(0, 5) ]); ?>;
                "></div>
            ...
            <div class="starburst">
                ...
                <div class="star-ray" style="transform: rotate(<?php echo e($i * 45); ?>deg)"></div>
                <?php endfor; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            </div>
            ...
            <div class="text-center relative" style="z-index: 10;">
                ...
                ">
                    🎉 <?php echo e(__('Complimenti!')); ?> 🎉
                </h1>
                
                <!-- Badge Icon with Glow -->
                <div class="badge-icon-container mb-4">
                    <div class="badge-glow"></div>
                    <img src="<?php echo e($badge->icon_url ?? asset('assets/images/draghetto.png')); ?>" 
                         alt="<?php echo e($badge->name); ?>" 
                ...
                <!-- Badge Description -->
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($badge->description): ?>
                ...
                <div class="flex justify-center gap-4 mt-5">
                    ...
                    <div class="stat-card stat-card-points">
                        ...
                        <div class="stat-value">+<?php echo e($points); ?></div>
                        <div class="stat-label"><?php echo e(__('Punti Guadagnati')); ?></div>
                    </div>
                    ...
                    <div class="stat-card stat-card-level">
                        ...
                        <div class="stat-value">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($leveledUp): ?>
                            <span class="level-up-animation">
                                <?php echo e($previousLevel); ?> → <?php echo e($level); ?>

                            </span>
                            <?php else: ?>
                            <?php echo e(__('Livello')); ?> <?php echo e($level); ?>

                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        </div>
                        <div class="stat-label">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($leveledUp): ?>
                            🎊 <?php echo e(__('Livello Aumentato!')); ?> 🎊
                            <?php else: ?>
                            <?php echo e(__('Livello Attuale')); ?>
...
<?php /**PATH C:\xampp\htdocs\slamin_v2\resources\views/livewire/badge-notification.blade.php ENDPATH**/ ?>