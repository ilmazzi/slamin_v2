<div>
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($media && $media->count() > 0): ?>
    <section>
        <div class="max-w-[90rem] mx-auto px-4 md:px-6 lg:px-8">
            ...
            <div class="text-center mb-12 section-title-fade">
                <h2 class="text-4xl md:text-5xl font-bold mb-3 text-neutral-900 dark:text-white" style="font-family: 'Crimson Pro', serif;">
                    <?php echo __('home.videos_section_title'); ?>

                </h2>
                <p class="text-lg text-neutral-600 dark:text-neutral-200 font-medium"><?php echo e(__('home.videos_section_subtitle')); ?></p>
            </div>
            ...
            <div x-ref="scrollContainer" class="flex gap-6 overflow-x-auto pb-16 pt-12 px-8 md:px-12 scrollbar-hide"
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $media; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php
                    // Random tilt
                    $tilt = rand(-1, 1);
                ?>
                <div class="w-[92vw] md:w-[700px] flex-shrink-0 fade-scale-item"
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($item->media_type === 'video'): ?>
                    <!-- Film Strip Container (VIDEO) -->
                    <div class="film-strip-container" style="transform: rotate(<?php echo e($tilt); ?>deg);">
                        <!-- Film Perforations Left - Brown strip -->
                        <div class="film-perforation film-perforation-left">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php for($h = 0; $h < 12; $h++): ?>
                        ...
                        <div class="film-frame">
                            ...
                            <div class="film-frame-number film-frame-number-tl">///<?php echo e(str_pad($i + 1, 2, '0', STR_PAD_LEFT)); ?></div>
                            <div class="film-frame-number film-frame-number-tr"><?php echo e(str_pad($i + 1, 2, '0', STR_PAD_LEFT)); ?>A</div>
                            ...
                            <div class="relative aspect-[4/3] md:aspect-video overflow-hidden bg-black cursor-pointer group"
                                ...
                                <img src="<?php echo e($item->thumbnail_url); ?>" 
                                     ...
                                     onerror="this.src='<?php echo e(asset('assets/images/placeholder/placholder-1.jpg')); ?>'">
                            ...
                            <div class="mt-3 px-3 pb-3 space-y-2">
                                ...
                                <div class="flex items-center gap-2">
                                    <img src="<?php echo e($item->user->profile_photo_url ?? 'https://ui-avatars.com/api/?name=' . urlencode($item->user->name) . '&background=059669&color=fff'); ?>" 
                                         alt="<?php echo e($item->user->name); ?>"
                                         class="w-7 h-7 md:w-8 md:h-8 rounded-full object-cover ring-1 ring-white/30">
                                    <p class="font-semibold text-xs md:text-sm text-white/90"><?php echo e($item->user->name); ?></p>
                                </div>
                                ...
                                <div class="flex items-center gap-4 text-white/90">
                                    ...
                                    <div class="inline-flex items-center gap-1.5">
                                        ...
                                        <span class="text-xs md:text-sm"><?php echo e($item->view_count ?? 0); ?></span>
                                    </div>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.like-button','data' => ['itemId' => $item->id,'itemType' => 'video','isLiked' => false,'likesCount' => $item->like_count ?? 0,'size' => 'sm','class' => '[&_span]:!text-white/90 [&_svg]:!text-white/90 [&_svg]:w-5 [&_svg]:h-5 md:[&_svg]:w-6 md:[&_svg]:h-6']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['itemId' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($item->id),'itemType' => 'video','isLiked' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(false),'likesCount' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($item->like_count ?? 0),'size' => 'sm','class' => '[&_span]:!text-white/90 [&_svg]:!text-white/90 [&_svg]:w-5 [&_svg]:h-5 md:[&_svg]:w-6 md:[&_svg]:h-6']); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.comment-button','data' => ['itemId' => $item->id,'itemType' => 'video','commentsCount' => $item->comment_count ?? 0,'size' => 'sm','class' => '[&_button]:!text-white/90 [&_span]:!text-white/90 [&_svg]:!stroke-white [&_svg]:w-5 [&_svg]:h-5 md:[&_svg]:w-6 md:[&_svg]:h-6']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['itemId' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($item->id),'itemType' => 'video','commentsCount' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($item->comment_count ?? 0),'size' => 'sm','class' => '[&_button]:!text-white/90 [&_span]:!text-white/90 [&_svg]:!stroke-white [&_svg]:w-5 [&_svg]:h-5 md:[&_svg]:w-6 md:[&_svg]:h-6']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
                    ...
                    <div class="home-photo-frame" style="transform: rotate(<?php echo e($tilt); ?>deg);">
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.photo-frame-light','data' => ['photo' => $item,'index' => $i,'size' => 'normal']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['photo' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($item),'index' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($i),'size' => 'normal']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
            ...
            <div class="text-center mt-12">
                <a href="<?php echo e(route('media.index')); ?>" 
                   ...
                   style="font-family: 'Crimson Pro', serif;">
                    → <?php echo e(__('home.all_videos_button')); ?>
            ...
            <div class="flex flex-col items-center justify-center py-20 px-4">
                <div class="text-center max-w-md">
                    ...
                    <h3 class="text-2xl font-bold text-neutral-900 dark:text-white mb-3" style="font-family: 'Crimson Pro', serif;">
                        <?php echo e(__('home.no_videos_title')); ?>

                    </h3>
                    <p class="text-neutral-600 dark:text-neutral-400 mb-6">
                        <?php echo e(__('home.no_videos_subtitle')); ?>

                    </p>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->guard()->check()): ?>
                    <a href="<?php echo e(route('media.upload.video')); ?>" 
...
$key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-3758497455-0', null);
...
$key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-3758497455-1', null);
...
<?php /**PATH C:\xampp\htdocs\slamin_v2\resources\views/livewire/home/videos-section.blade.php ENDPATH**/ ?>