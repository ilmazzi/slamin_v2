<div>
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($isOpen && $poem): ?>
    <!-- Modal Overlay -->
    <div x-data="{ show: <?php if ((object) ('isOpen') instanceof \Livewire\WireDirective) : ?>window.Livewire.find('<?php echo e($__livewire->getId()); ?>').entangle('<?php echo e('isOpen'->value()); ?>')<?php echo e('isOpen'->hasModifier('live') ? '.live' : ''); ?><?php else : ?>window.Livewire.find('<?php echo e($__livewire->getId()); ?>').entangle('<?php echo e('isOpen'); ?>')<?php endif; ?>, poem: <?php if ((object) ('poem') instanceof \Livewire\WireDirective) : ?>window.Livewire.find('<?php echo e($__livewire->getId()); ?>').entangle('<?php echo e('poem'->value()); ?>')<?php echo e('poem'->hasModifier('live') ? '.live' : ''); ?><?php else : ?>window.Livewire.find('<?php echo e($__livewire->getId()); ?>').entangle('<?php echo e('poem'); ?>')<?php endif; ?>, leftOpen: false, rightOpen: false }"
         x-show="show"
                        ...
                        <div class="poem-page-content">
                            <div class="poem-left-meta">
                                <div class="poem-left-header">
                                    <img src="<?php echo e(\App\Helpers\AvatarHelper::getUserAvatarUrl($poem->user, 120)); ?>" 
                                    ...
                                    <div class="poem-left-header-info">
                                        <div class="poem-left-author">
                                            <a href="<?php echo e(\App\Helpers\AvatarHelper::getUserProfileUrl($poem->user)); ?>" 
                                               class="hover:underline transition-colors">
                                                <h3><?php echo e(\App\Helpers\AvatarHelper::getDisplayName($poem->user)); ?></h3>
                                            </a>
                                            <p>Poeta</p>
                                        </div>
                                        ...
                                        <div class="poem-left-stats-inline">
                                            <div class="poem-left-stats">
                                                <p class="count"><?php echo e($poem->like_count ?? 0); ?></p>
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($poem->thumbnail_url): ?>
                                    <div class="poem-modal-cover poem-modal-cover-left">
                                        <img src="<?php echo e($poem->thumbnail_url); ?>"
                                             alt="<?php echo e($poem->title ?: __('poems.untitled')); ?>"
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->guard()->check()): ?>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->id() === $poem->user_id): ?>
                                        <div class="poem-owner-actions-bar">
                                            <div class="poem-owner-actions">
                                                <a href="<?php echo e(route('poems.edit', $poem->slug)); ?>" class="poem-owner-action">
                                                    ...
                                                    <span><?php echo e(__('poems.show.edit_poem')); ?></span>
                                                </a>
                                                <button type="button" wire:click="emitTranslationRequest" class="poem-owner-action">
                                                    <svg class="poem-owner-action-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 5h12M9 3v2m1.048 9.5A18.022 18.022 0 016.412 9m6.088 9h7M11 21l5-10 5 10M12.751 5C11.783 10.77 8.07 15.61 3 18.129" />
                                                    </svg>
                                                    <span><?php echo e(__('translations.request_translation')); ?></span>
                                                </button>
                                                <a href="<?php echo e(route('poems.my-poems')); ?>" class="poem-owner-action">
                                                    <svg class="poem-owner-action-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7" />
                                                    </svg>
                                                    <span><?php echo e(__('poems.my_poems.title')); ?></span>
                                                </a>
                                            </div>
                                        </div>
                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.like-button','data' => ['itemId' => $poem->id,'itemType' => 'poem','isLiked' => $poem->is_liked ?? false,'likesCount' => $poem->like_count ?? 0,'size' => 'md']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['itemId' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($poem->id),'itemType' => 'poem','isLiked' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($poem->is_liked ?? false),'likesCount' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($poem->like_count ?? 0),'size' => 'md']); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.comment-button','data' => ['itemId' => $poem->id,'itemType' => 'poem','commentsCount' => $poem->comment_count ?? 0,'size' => 'md']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['itemId' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($poem->id),'itemType' => 'poem','commentsCount' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($poem->comment_count ?? 0),'size' => 'md']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.share-button','data' => ['url' => route('poems.show', $poem->slug),'title' => $poem->title ?: __('poems.untitled'),'size' => 'md']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['url' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('poems.show', $poem->slug)),'title' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($poem->title ?: __('poems.untitled')),'size' => 'md']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.report-button','data' => ['itemId' => $poem->id,'itemType' => 'poem','size' => 'md']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['itemId' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($poem->id),'itemType' => 'poem','size' => 'md']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
                                ...
                                <p class="text-sm text-neutral-500 italic text-center mt-4">
                                    <?php echo e($poem->created_at->format('d M Y')); ?>
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($poem): ?>
        <?php
$__split = function ($name, $params = []) {
    return [$name, $params];
};
[$__name, $__params] = $__split('translations.translation-request', ['poem' => $poem]);

$key = 'translation-request-'.$poem->id;

$key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-1768987966-0', 'translation-request-'.$poem->id);
...
<?php /**PATH C:\xampp\htdocs\slamin_v2\resources\views/livewire/poems/poem-modal.blade.php ENDPATH**/ ?>