                    ...
                    <div class="bg-white dark:bg-neutral-800 rounded-xl shadow-lg p-6 sticky top-6">
                        ...
                        <div class="space-y-2 mb-4">
                            <div class="flex justify-between">
                                ...
                                <span class="font-semibold text-neutral-900 dark:text-white">€<?php echo e(number_format($amount, 2)); ?></span>
                            </div>
                            <div class="flex justify-between text-sm">
                                <span class="text-neutral-600 dark:text-neutral-400">Commissione piattaforma:</span>
                                <span class="text-neutral-700 dark:text-neutral-300">€<?php echo e(number_format($commissionData['commission_total'], 2)); ?></span>
                            </div>
                        </div>
                        ...
                        <div class="pt-4 border-t border-neutral-200 dark:border-neutral-700">
                            <div class="flex justify-between items-center">
                                ...
                                <span class="text-2xl font-black text-primary-600 dark:text-primary-400">€<?php echo e(number_format($amount, 2)); ?></span>
                            </div>
                            <p class="text-xs text-neutral-500 dark:text-neutral-400 mt-2">
                                Il traduttore riceverà €<?php echo e(number_format($commissionData['translator_amount'], 2)); ?>
                        ...
                        <div class="mb-6">
                            <div class="flex gap-2 border-b border-neutral-200 dark:border-neutral-700">
                                <button type="button"
                                        ...
                                        class="px-4 py-2 font-semibold transition-colors border-b-2 <?php echo e($paymentMethod === 'stripe' ? 'border-primary-600 text-primary-600' : 'border-transparent text-neutral-600 dark:text-neutral-400 hover:text-neutral-900 dark:hover:text-white'); ?>">
                                    💳 Carta di Credito
                                </button>
                                <button type="button"
                                        wire:click="$set('paymentMethod', 'offline')"
                                        class="px-4 py-2 font-semibold transition-colors border-b-2 <?php echo e($paymentMethod === 'offline' ? 'border-primary-600 text-primary-600' : 'border-transparent text-neutral-600 dark:text-neutral-400 hover:text-neutral-900 dark:hover:text-white'); ?>">
                                    💰 Pagamento Offline
                                </button>
                            </div>
                        </div>
                            ...
                            <div id="stripe-payment-form">
                                ...
                                <button type="button" 
                                    ...
                                    <span wire:loading.remove>
                                        💳 Paga €<?php echo e(number_format($amount, 2)); ?>
