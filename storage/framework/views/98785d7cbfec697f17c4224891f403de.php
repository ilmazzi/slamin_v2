        ...
        <div class="relative z-10 max-w-6xl mx-auto px-6 text-center"
            ...
            <div class="mb-8">
                <a href="<?php echo e(route('gigs.index')); ?>" 
                   class="inline-flex items-center gap-3 px-6 py-3 backdrop-blur-xl bg-white/10 hover:bg-white/20 border-2 border-white/20 hover:border-white/40 transition-all group">
                    ...
                    <span class="text-white font-black uppercase tracking-wider text-sm"><?php echo e(__('gigs.back_to_list')); ?></span>
                </a>
            </div>

            
            <div class="flex flex-wrap justify-center gap-4 mb-8">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($gig->is_featured): ?>
                    <div class="group relative px-6 py-3 backdrop-blur-xl bg-blue-500/90 border-2 border-white/30 overflow-hidden hover:scale-105 transition-all animate-pulse">
                        <span class="relative text-white text-sm font-black uppercase tracking-[0.2em] flex items-center gap-2">
                            ...
                            <?php echo e(__('gigs.status.featured')); ?>
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($gig->is_urgent): ?>
                    <div class="group relative px-6 py-3 backdrop-blur-xl bg-gradient-to-r from-orange-500 to-red-600 border-2 border-white/30 overflow-hidden hover:scale-105 transition-all animate-pulse">
                        <span class="relative text-white text-sm font-black uppercase tracking-[0.2em] flex items-center gap-2">
                            ...
                            <?php echo e(__('gigs.status.urgent')); ?>

                        </span>
                    </div>
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>

                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($gig->is_remote): ?>
                    <div class="group relative px-6 py-3 backdrop-blur-xl bg-green-500/90 border-2 border-white/30 overflow-hidden hover:scale-105 transition-all">
                        <span class="relative text-white text-sm font-black uppercase tracking-[0.2em] flex items-center gap-2">
                            ...
                            <?php echo e(__('gigs.remote')); ?>

                        </span>
                    </div>
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>

                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($gig->is_closed): ?>
                    <div class="group relative px-6 py-3 backdrop-blur-xl bg-red-600/90 border-2 border-white/30 overflow-hidden">
                        <span class="relative text-white text-sm font-black uppercase tracking-[0.2em] flex items-center gap-2">
                            ...
                            <?php echo e(__('gigs.status.closed')); ?>
                ...
                <div class="group relative px-6 py-3 backdrop-blur-xl <?php echo e($gig->type === 'paid' ? 'bg-accent-500/90' : 'bg-primary-500/90'); ?> border-2 border-white/20 overflow-hidden hover:scale-105 transition-all">
                    <span class="relative text-white text-sm font-black uppercase tracking-[0.2em]">
            ...
            <div class="flex flex-wrap justify-center items-center gap-8 text-white/90">
                <div class="flex items-center gap-3">
                    ...
                    <span class="font-bold text-lg"><?php echo e($gig->user ? $gig->user->name : ($gig->requester ? $gig->requester->name : __('gigs.anonymous'))); ?></span>
                </div>
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($gig->location): ?>
                    <div class="flex items-center gap-3">
                        ...
                        <span class="font-bold text-lg"><?php echo e($gig->location); ?></span>
                    </div>
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($gig->deadline): ?>
                    <div class="flex items-center gap-3">
                        ...
                        <span class="font-bold text-lg"><?php echo e($gig->deadline->format('d M Y H:i')); ?></span>
                    </div>
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            </div>
        </div>
        ...
        <div class="max-w-6xl mx-auto px-6">
            ...
            <div class="grid lg:grid-cols-3 gap-8">
                ...
                <div class="lg:col-span-2 space-y-8">
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($gig->poem_id && $gig->poem): ?>
                                ...
                                <div class="space-y-4">
                                    <div class="bg-white/80 dark:bg-neutral-900/50 rounded-lg p-6 backdrop-blur-sm">
                                        <h3 class="text-2xl font-bold text-neutral-900 dark:text-white mb-2 font-poem">
                                            "<?php echo e($gig->poem->title); ?>"
                                        </h3>
                                        <p class="text-sm text-neutral-600 dark:text-neutral-400 mb-4">
                                            di <?php echo e($gig->poem->user->name); ?>

                                        </p>
                                        <button onclick="Livewire.dispatch('openPoemModal', { poemId: <?php echo e($gig->poem->id); ?> })" 
                                    ...
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($gig->target_language): ?>
                                        <div class="flex items-center gap-2 text-sm">
                                            ...
                                            <span class="px-3 py-1 bg-accent-100 dark:bg-accent-900/30 text-accent-700 dark:text-accent-300 rounded-full font-bold">
                                                <?php echo e(strtoupper($gig->target_language)); ?>
                        ...
                        <div class="relative p-8">
                            <div class="flex items-center gap-4 mb-6">
                                ...
                                <h2 class="text-3xl font-black text-neutral-900 dark:text-white uppercase tracking-tight">
                                    <?php echo e(__('gigs.fields.description')); ?>
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($gig->requirements): ?>
                        <div class="group relative bg-white dark:bg-neutral-800 overflow-hidden border-l-4 border-blue-500 shadow-2xl hover:shadow-[0_20px_50px_rgba(0,0,0,0.2)] transition-all duration-500">
                            ...
                            <div class="relative p-8">
                                <div class="flex items-center gap-4 mb-6">
                                    ...
                                    <h2 class="text-3xl font-black text-neutral-900 dark:text-white uppercase tracking-tight">
                                        <?php echo e(__('gigs.fields.requirements')); ?>

                                    </h2>
                                </div>
                                <div class="prose prose-lg prose-neutral dark:prose-invert max-w-none">
                                    <?php echo nl2br(e($gig->requirements)); ?>
                ...
                <div class="space-y-6">
                            ...
                            <div class="space-y-4">
                                ...
                                <div class="flex items-center justify-between p-4 bg-primary-50 dark:bg-primary-950/30 border-l-4 border-primary-500">
                                    ...
                                    <span class="text-2xl font-black text-primary-600 dark:text-primary-400">
                                        <?php echo e($gig->application_count); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($gig->max_applications): ?><span class="text-base text-neutral-500">/<?php echo e($gig->max_applications); ?></span><?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                    </span>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="sticky top-6 bg-white dark:bg-neutral-800 shadow-2xl overflow-hidden border-t-4 border-accent-500">
                        <div class="p-6">
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($userApplication): ?>
                                ...
                                <div class="space-y-4">
                                        ...
                                        <div class="flex items-start gap-3">
                                            ...
                                            <div class="flex-1">
                                                <h4 class="font-black text-blue-900 dark:text-blue-100 mb-1 uppercase text-sm tracking-wider">
                                                    <?php echo e(__('gigs.applications.already_applied')); ?>

                                                </h4>
                                                <p class="text-sm text-blue-700 dark:text-blue-300 font-bold">
                                                    <?php echo e(__('gigs.applications.status')); ?>: <?php echo e(__('gigs.applications.status_' . $userApplication->status)); ?>

                                                </p>
                                                <p class="text-xs text-blue-600 dark:text-blue-400 mt-1">
                                                    <?php echo e($userApplication->created_at->format('d M Y H:i')); ?>
                                    ...
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($userApplication->status === 'pending'): ?>
                                        <?php
$__split = function ($name, $params = []) {
    return [$name, $params];
};
[$__name, $__params] = $__split('gigs.negotiation-chat', ['application' => $userApplication]);

$key = 'negotiation-'.$userApplication->id;

$key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-3579651092-0', 'negotiation-'.$userApplication->id);
...
?>
                                    <?php elseif($userApplication->status === 'accepted'): ?>
                                        
                                        <a href="<?php echo e(route('gigs.workspace', $userApplication)); ?>" 
                            ...
                            <?php elseif($isOwner): ?>
                                ...
                                <div class="space-y-3">
                                    ...
                                    <a href="<?php echo e(route('gigs.edit', $gig)); ?>" 
                                       class="block w-full px-6 py-4 bg-gradient-to-r from-primary-600 to-primary-700 hover:from-primary-700 hover:to-primary-800 text-white font-black text-center uppercase tracking-wider transition-all hover:shadow-2xl hover:scale-105">
                                        <?php echo e(__('gigs.edit')); ?>

                                    </a>

                                    <a href="<?php echo e(route('gigs.applications', $gig)); ?>" 
                                       class="block w-full px-6 py-4 bg-neutral-200 dark:bg-neutral-700 hover:bg-neutral-300 dark:hover:bg-neutral-600 text-neutral-900 dark:text-white font-black text-center uppercase tracking-wider transition-all hover:shadow-2xl hover:scale-105">
                                        <?php echo e(__('gigs.applications.manage_applications')); ?> (<?php echo e($gig->application_count); ?>)
                                    </a>
                                    ...
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($gig->is_closed): ?>
                                        <button wire:click="reopenGig" 
                                            ...
                                            <?php echo e(__('gigs.actions.reopen_gig')); ?>
                                    ...
                                    <?php else: ?>
                                        <button wire:click="closeGig" 
                                            ...
                                            <?php echo e(__('gigs.actions.close_gig')); ?>

                                        </button>
                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                </div>

                            <?php elseif($canApply && !$showApplicationForm): ?>
                                ...
                                <button wire:click="toggleApplicationForm" 
                                    ...
                                    <span class="relative"><?php echo e(__('gigs.applications.apply')); ?></span>
                                </button>

                            <?php elseif(!$canApply && !auth()->check()): ?>
                                ...
                                <a href="<?php echo e(route('login')); ?>" 
                                   class="block w-full px-8 py-6 bg-neutral-300 dark:bg-neutral-700 hover:bg-neutral-400 dark:hover:bg-neutral-600 text-neutral-900 dark:text-white font-black text-xl text-center uppercase tracking-wider transition-all hover:shadow-2xl hover:scale-105">
                                    <?php echo e(__('gigs.messages.login_to_interact')); ?>
                            ...
                            <?php elseif(!$canApply): ?>
                                ...
                                <div class="bg-neutral-100 dark:bg-neutral-800 p-4 text-center text-neutral-600 dark:text-neutral-400 font-bold">
                                    <?php echo e(__('gigs.applications.cannot_apply')); ?>
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($showApplicationForm): ?>
                <div class="mt-12">
                        ...
                        <div class="p-8 md:p-12">
                            <div class="flex items-center gap-4 mb-8">
                                ...
                                <h3 class="text-3xl md:text-4xl font-black text-neutral-900 dark:text-white uppercase tracking-tight">
                                    <?php echo e(__('gigs.applications.submit_application')); ?>
                            ...
                            <form wire:submit.prevent="submitApplication" class="space-y-6">
                                ...
                                <div>
                                    <label class="block text-sm font-black text-neutral-900 dark:text-white uppercase tracking-wider mb-3">
                                        <?php echo e(__('gigs.applications.message')); ?> <span class="text-red-500">*</span>
                                    </label>
                                    <textarea wire:model="applicationMessage" 
                                              ...
                                              placeholder="<?php echo e(__('gigs.applications.message_placeholder')); ?>"></textarea>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['applicationMessage'];
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                ...
                                <div class="grid md:grid-cols-2 gap-6">
                                    ...
                                    <div>
                                        <label class="block text-sm font-black text-neutral-900 dark:text-white uppercase tracking-wider mb-3">
                                            <?php echo e(__('gigs.applications.experience')); ?>
                                    ...
                                    <div>
                                        <label class="block text-sm font-black text-neutral-900 dark:text-white uppercase tracking-wider mb-3">
                                            <?php echo e(__('gigs.applications.availability')); ?>
                                ...
                                <div class="grid md:grid-cols-2 gap-6">
                                    ...
                                    <div>
                                        <label class="block text-sm font-black text-neutral-900 dark:text-white uppercase tracking-wider mb-3">
                                            <?php echo e(__('gigs.applications.portfolio_url')); ?>
                                ...
                                <div class="flex flex-col md:flex-row gap-4 pt-6">
                                    <button type="submit" 
                                        ...
                                        <span class="absolute inset-0 bg-gradient-to-r from-white/0 via-white/20 to-white/0 translate-x-[-100%] group-hover:translate-x-[100%] transition-transform duration-1000"></span>
                                        <span class="relative"><?php echo e(__('gigs.applications.submit_application')); ?></span>
                                    </button>
...
$key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-3579651092-1', null);
