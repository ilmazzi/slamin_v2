<div class="min-h-screen bg-neutral-50 dark:bg-neutral-900" wire:poll.5s>
            ...
            <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                <div>
                    ...
                    <p class="text-white/90 text-sm">
                        Poesia: <span class="font-semibold">"<?php echo e($application->gig->poem->title); ?>"</span>
                        → <?php echo e(strtoupper($application->gig->target_language)); ?>
                ...
                <div class="flex items-center gap-3">
                    <div class="px-4 py-2 bg-white/20 backdrop-blur-sm rounded-lg text-white font-semibold">
                        Versione <?php echo e($translation->version); ?>

                    </div>
                    <div class="px-4 py-2 rounded-lg font-semibold
                        <?php echo e($translation->status === 'draft' ? 'bg-yellow-500/20 text-yellow-100' : ''); ?>

                        <?php echo e($translation->status === 'in_review' ? 'bg-blue-500/20 text-blue-100' : ''); ?>

                        <?php echo e($translation->status === 'approved' ? 'bg-green-500/20 text-green-100' : ''); ?>">
                        <?php echo e(ucfirst($translation->status)); ?>
            ...
            <div class="lg:col-span-1">
                <div class="sticky top-6 bg-white dark:bg-neutral-800 rounded-xl shadow-lg p-6">
                    ...
                    <div class="prose prose-sm dark:prose-invert max-w-none">
                        <h3 class="font-poem text-lg">"<?php echo e($application->gig->poem->title); ?>"</h3>
                        <p class="text-sm text-neutral-600 dark:text-neutral-400 mb-4">
                            di <?php echo e($application->gig->poem->user->name); ?>

                        </p>
                        <div class="font-poem text-neutral-700 dark:text-neutral-300 leading-relaxed">
                            <?php echo $application->gig->poem->content; ?>
            ...
            <div class="lg:col-span-2 space-y-6">
                    ...
                    <div class="p-6 border-b border-neutral-200 dark:border-neutral-700">
                        <div class="flex items-center justify-between">
                            ...
                            <button wire:click="$toggle('showVersionHistory')" 
                                ...
                                Storico (<?php echo e($versions->count()); ?>)
                            </button>
                        </div>
                    </div>
                    ...
                    <div class="p-6">
                        ...
                        <div x-data="{ 
                            ...
                            <textarea x-ref="editor"
                                      ...
                                      <?php echo e($translation->status === 'approved' ? 'disabled' : ''); ?>></textarea>
                        </div>
                        
                        
                        <div class="flex flex-wrap gap-3 mt-4">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($translation->status !== 'approved'): ?>
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($isTranslator && $translation->status === 'draft'): ?>
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($isAuthor && $translation->status === 'in_review'): ?>
                ...
                <div class="bg-white dark:bg-neutral-800 rounded-xl shadow-lg p-6">
                    <h3 class="text-lg font-bold text-neutral-900 dark:text-white mb-4 flex items-center gap-2">
                        ...
                        Commenti (<?php echo e($comments->count()); ?>)
                    </h3>
                    
                    
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($showCommentForm && $translation->status !== 'approved'): ?>
                        <div class="mb-6 p-4 bg-yellow-50 dark:bg-yellow-900/20 border-2 border-yellow-300 dark:border-yellow-700 rounded-lg">
                            <p class="text-sm text-neutral-700 dark:text-neutral-300 mb-2">
                                ...
                                <span class="italic">"<?php echo e(\Str::limit($selectedText, 100)); ?>"</span>
                            </p>
                    ...
                    <div class="space-y-4">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $comments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $comment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <div class="p-4 rounded-lg <?php echo e($comment->is_resolved ? 'bg-neutral-100 dark:bg-neutral-900 opacity-60' : 'bg-yellow-50 dark:bg-yellow-900/20 border border-yellow-300 dark:border-yellow-700'); ?>">
                                <div class="flex items-start justify-between mb-2">
                                    <div class="flex items-center gap-2">
                                        <img src="<?php echo e(\App\Helpers\AvatarHelper::getUserAvatarUrl($comment->user, 64)); ?>" 
                                    ...
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!$comment->is_resolved && $translation->status !== 'approved'): ?>
                                        <button wire:click="resolveComment(<?php echo e($comment->id); ?>)" 
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($comment->highlighted_text): ?>
                                    <div class="mb-2 p-2 bg-white dark:bg-neutral-800 rounded border-l-4 border-yellow-500">
                                        <p class="text-xs text-neutral-600 dark:text-neutral-400 italic">
                                            "<?php echo e($comment->highlighted_text); ?>"
                                        </p>
                                    </div>
                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($comment->is_resolved): ?>
                                    <div class="mt-2 text-xs text-green-600 dark:text-green-400">
                                        ✓ Risolto da <?php echo e($comment->resolver->name); ?> <?php echo e($comment->resolved_at->diffForHumans()); ?>
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($showVersionHistory): ?>
                    <div class="bg-white dark:bg-neutral-800 rounded-xl shadow-lg p-6">
                        ...
                        <div class="space-y-3">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $versions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $version): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <div class="flex items-center justify-between mb-2">
                                        <div class="flex items-center gap-2">
                                            ...
                                            <span class="text-sm font-semibold text-neutral-900 dark:text-white">
                                                <?php echo e($version->modifier->name); ?>

                                            </span>
                                        </div>
                                        <span class="text-xs text-neutral-500 dark:text-neutral-400">
                                            <?php echo e($version->created_at->format('d M Y H:i')); ?>

                                        </span>
                                    </div>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($version->changes_summary): ?>
                                        <p class="text-sm text-neutral-600 dark:text-neutral-400">
                                            <?php echo e($version->changes_summary); ?>
...
<?php /**PATH C:\xampp\htdocs\slamin_v2\resources\views/livewire/translations/translation-workspace.blade.php ENDPATH**/ ?>