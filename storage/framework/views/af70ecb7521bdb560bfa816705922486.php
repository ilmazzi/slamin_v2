...
[$__name, $__params] = $__split('tutorial.onboarding-tutorial', []);
...
<?php endif; ?>
    ...
    <!-- Feedback Widget -->
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(config('openproject-feedback.widget.enabled', true)): ?>
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!config('openproject-feedback.widget.show_only_authenticated', true) || auth()->check()): ?>
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(config('openproject-feedback.widget.show_only_authenticated', true) && auth()->check()): ?>
                <script>
                    (function() {
                        function addAuthClass() {
                            if (document.body) {
                                ...
                                document.body.setAttribute('data-user-id', '<?php echo e(auth()->id()); ?>');
                            } else {
            ...
            <script>
                window.OpenProjectFeedbackConfig = {
                    route: '<?php echo e(route('openproject-feedback.store')); ?>',
                    position: '<?php echo e(config('openproject-feedback.widget.position', 'bottom-left')); ?>',
                    offset: {
                        bottom: <?php echo e(config('openproject-feedback.widget.offset.bottom', 64)); ?>,
                        top: <?php echo e(config('openproject-feedback.widget.offset.top', 16)); ?>,
                        left: <?php echo e(config('openproject-feedback.widget.offset.left', 0)); ?>,
                        right: <?php echo e(config('openproject-feedback.widget.offset.right', 16)); ?>,
                    },
                    zIndex: <?php echo e(config('openproject-feedback.widget.z_index', 50)); ?>,
                    colors: {
                        primary: '<?php echo e(config('openproject-feedback.widget.color.primary', '#3b82f6')); ?>',
                        hover: '<?php echo e(config('openproject-feedback.widget.color.hover', '#2563eb')); ?>',
                    },
                    text: '<?php echo e(config('openproject-feedback.widget.text', 'FEEDBACK')); ?>',
                    showOnlyAuthenticated: <?php echo e(config('openproject-feedback.widget.show_only_authenticated', true) ? 'true' : 'false'); ?>,
                };
            </script>
            <?php
            ...
            ?>
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($widgetFile): ?>
                <script src="<?php echo e(asset('build/' . $widgetFile)); ?>"></script>
            <?php else: ?>
                <?php echo app('Illuminate\Foundation\Vite')(['resources/js/vendor/openproject-feedback/feedback-widget.js']); ?>
            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
</body>
