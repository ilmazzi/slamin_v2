<div x-data="{ 
    ...
    reason: <?php if ((object) ('reason') instanceof \Livewire\WireDirective) : ?>window.Livewire.find('<?php echo e($__livewire->getId()); ?>').entangle('<?php echo e('reason'->value()); ?>')<?php echo e('reason'->hasModifier('live') ? '.live' : ''); ?><?php else : ?>window.Livewire.find('<?php echo e($__livewire->getId()); ?>').entangle('<?php echo e('reason'); ?>')<?php endif; ?>,
    description: <?php if ((object) ('description') instanceof \Livewire\WireDirective) : ?>window.Livewire.find('<?php echo e($__livewire->getId()); ?>').entangle('<?php echo e('description'->value()); ?>')<?php echo e('description'->hasModifier('live') ? '.live' : ''); ?><?php else : ?>window.Livewire.find('<?php echo e($__livewire->getId()); ?>').entangle('<?php echo e('description'); ?>')<?php endif; ?>
}"
     x-show="show"
                    ...
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            <h3 class="text-xl font-bold text-white">
                                <?php echo e(__('report.modal_title')); ?>

                            </h3>
                            <p class="text-white/80 text-sm">
                                <?php echo e(__('report.modal_subtitle')); ?>
                ...
                <form wire:submit.prevent="submitReport">
                    ...
                    <div class="mb-6">
                        <label class="block text-sm font-semibold text-neutral-700 dark:text-neutral-300 mb-3">
                            <?php echo e(__('report.select_reason')); ?> <span class="text-red-500">*</span>
                        </label>
                        <div class="space-y-2">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $reasons; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <label class="flex items-center gap-3 p-3 rounded-xl border-2 cursor-pointer transition-all hover:bg-neutral-50 dark:hover:bg-neutral-800"
                                   :class="reason === '<?php echo e($value); ?>' ? 'border-red-500 bg-red-50 dark:bg-red-900/20' : 'border-neutral-200 dark:border-neutral-700'">
                                <input type="radio" 
                                       wire:model="reason" 
                                ...
                                <div>
                                    ...
                                    <div class="text-xs text-neutral-600 dark:text-neutral-400">
                                        <?php echo e(__('report.reasons.' . $value . '_desc')); ?>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    ...
                    <div class="mb-6">
                        <label for="description" class="block text-sm font-semibold text-neutral-700 dark:text-neutral-300 mb-2">
                            <?php echo e(__('report.additional_details')); ?>
                        ...
                        <textarea 
                            ...
                            id="description"
                            rows="3"
                            placeholder="<?php echo e(__('report.description_placeholder')); ?>"
                        ...
                        <p class="mt-1 text-xs text-neutral-500 dark:text-neutral-400">
                            <?php echo e(__('report.max_characters', ['max' => 1000])); ?>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    ...
                    <div class="mt-4 p-3 bg-blue-50 dark:bg-blue-900/20 rounded-xl">
                        <p class="text-xs text-blue-800 dark:text-blue-300">
                            ℹ️ <?php echo e(__('report.info_message')); ?>
...
<?php /**PATH C:\xampp\htdocs\slamin_v2\resources\views/livewire/moderation/report-modal.blade.php ENDPATH**/ ?>