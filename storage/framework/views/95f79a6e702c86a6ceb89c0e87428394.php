...
<div x-data="{ 
    ...
    fediverseInstance: '',
    shareUrl: '<?php echo e($shareUrl); ?>',
    shareTitle: '<?php echo e(addslashes($shareTitle)); ?>',
    ...
    copyLink() {
        navigator.clipboard.writeText(this.shareUrl).then(() => {
            this.$dispatch('notify', { 
                message: '<?php echo e(__('social.link_copied')); ?>', 
                type: 'success' 
            });
            this.showModal = false;
        });
...
class="relative inline-block" <?php echo e($attributes->only(['class'])); ?>>
    <button type="button"
            @click="share()"
        ...
        <svg class="<?php echo e($iconSize); ?> group-hover:scale-110 group-hover:rotate-12 transition-all" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2">
        ...
        <div x-show="showModal"
            ...
            <div class="sticky top-0 bg-white dark:bg-neutral-800 border-b border-neutral-200 dark:border-neutral-700 px-6 py-4 flex items-center justify-between rounded-t-2xl">
                <h3 class="text-xl font-bold text-neutral-900 dark:text-white flex items-center gap-2">
                    ...
                    <?php echo e(__('social.share_title')); ?>
            ...
            <div class="p-6 space-y-3">
                ...
                <button @click="copyLink()" 
                    ...
                    <div class="flex-1 text-left">
                        <div class="font-bold text-neutral-900 dark:text-white"><?php echo e(__('social.copy_link')); ?></div>
                        <div class="text-sm text-neutral-600 dark:text-neutral-400"><?php echo e(__('social.copy_link_description')); ?></div>
                    </div>
                </button>
                ...
                <div class="relative">
                    ...
                    <div class="relative flex justify-center text-sm">
                        <span class="px-3 bg-white dark:bg-neutral-800 text-neutral-500 dark:text-neutral-400">
                            <?php echo e(__('social.share_on_social')); ?>
...
<?php /**PATH C:\xampp\htdocs\slamin_v2\resources\views/components/share-button.blade.php ENDPATH**/ ?>