...
<div class="flex flex-col h-full" 
     x-data="{
         ...
         typingUsers: [],
         typingTimeout: null,
         isOtherUserOnline: <?php echo e($isOnline ? 'true' : 'false'); ?>,
         init() {
             // Update online status every 30 seconds
             <?php if($conversation->type === 'private' && $otherUser): ?>
             setInterval(() => {
                 fetch('<?php echo e(route('api.users.check-online', $otherUser->id)); ?>', {
                     method: 'GET',
                     headers: {
             ...
             if (window.Echo) {
                 window.Echo.private('conversation.<?php echo e($conversation->id); ?>')
                     .listen('.user.started.typing', (e) => {
                         if (e.user_id !== <?php echo e(auth()->id()); ?>) {
    ...
    <div class="chat-header">
        ...
        <!-- Avatar -->
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($displayAvatar): ?>
            <img src="<?php echo e($displayAvatar); ?>" alt="<?php echo e($displayName); ?>" class="chat-avatar">
        <?php else: ?>
            <div class="chat-avatar-placeholder"><?php echo e(strtoupper(substr($displayName, 0, 2))); ?></div>
        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        
        <!-- Info -->
        <div class="chat-header-info">
            <h2 class="chat-header-name"><?php echo e($displayName); ?></h2>
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($conversation->type === 'private' && $otherUser): ?>
                <p class="chat-header-status" x-text="isOtherUserOnline ? '<?php echo e(__('chat.online')); ?>' : '<?php echo e(__('chat.offline')); ?>'"></p>
            <?php else: ?>
                <p class="chat-header-status">
                    <?php echo e($conversation->participants()->count()); ?> <?php echo e(__('chat.participants')); ?>
        ...
        <div class="chat-header-actions">
            <button class="chat-header-btn" title="<?php echo e(__('chat.search')); ?>">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z"/>
                </svg>
            </button>
            <button @click="showInfo = !showInfo" class="chat-header-btn" title="<?php echo e(__('chat.info')); ?>">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <div x-show="showInfo" 
        ...
        <div class="p-6 border-b border-neutral-200 dark:border-neutral-800 flex items-center justify-between">
            <h3 class="text-xl font-bold text-neutral-900 dark:text-white"><?php echo e(__('chat.conversation_info')); ?></h3>
        ...
        <div class="p-6 space-y-6">
            ...
            <div class="text-center">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($displayAvatar): ?>
                    <img src="<?php echo e($displayAvatar); ?>" alt="<?php echo e($displayName); ?>" class="w-24 h-24 rounded-full mx-auto mb-4 object-cover">
                <?php else: ?>
                ...
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                <h4 class="text-lg font-bold text-neutral-900 dark:text-white"><?php echo e($displayName); ?></h4>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($conversation->type === 'private' && $otherUser): ?>
                    <p class="text-sm text-neutral-500 dark:text-neutral-400" x-text="isOtherUserOnline ? '<?php echo e(__('chat.online')); ?>' : '<?php echo e(__('chat.offline')); ?>'"></p>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($otherUser->nickname): ?>
                        <p class="text-sm text-neutral-500 dark:text-neutral-400">@\<?php echo e($otherUser->nickname); ?></p>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            </div>
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($conversation->type === 'private' && $otherUser): ?>
                <div class="space-y-2">
                    <a href="<?php echo e(route('user.show', $otherUser)); ?>" 
                       class="flex items-center gap-3 p-3 rounded-lg hover:bg-neutral-100 dark:hover:bg-neutral-800 transition-colors">
                        ...
                        <span class="text-sm font-medium text-neutral-900 dark:text-white"><?php echo e(__('chat.view_profile')); ?></span>
                    </a>
                    ...
                    <button class="flex items-center gap-3 p-3 rounded-lg hover:bg-neutral-100 dark:hover:bg-neutral-800 transition-colors w-full text-left">
                        ...
                        <span class="text-sm font-medium text-neutral-900 dark:text-white"><?php echo e(__('chat.search_in_conversation')); ?></span>
                    </button>
                    ...
                    <button class="flex items-center gap-3 p-3 rounded-lg hover:bg-neutral-100 dark:hover:bg-neutral-800 transition-colors w-full text-left">
                        ...
                        <span class="text-sm font-medium text-neutral-900 dark:text-white"><?php echo e(__('chat.mute_notifications')); ?></span>
                    </button>
                </div>
            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            ...
            <div class="border-t border-neutral-200 dark:border-neutral-800 pt-6">
                <h5 class="text-sm font-semibold text-neutral-700 dark:text-neutral-300 mb-3"><?php echo e(__('chat.conversation_details')); ?></h5>
                <div class="space-y-2 text-sm">
                    <div class="flex justify-between">
                        <span class="text-neutral-600 dark:text-neutral-400"><?php echo e(__('chat.messages')); ?></span>
                        <span class="font-medium text-neutral-900 dark:text-white"><?php echo e($conversation->messages()->count()); ?></span>
                    </div>
                    <div class="flex justify-between">
                        <span class="text-neutral-600 dark:text-neutral-400"><?php echo e(__('chat.created')); ?></span>
                        <span class="font-medium text-neutral-900 dark:text-white"><?php echo e($conversation->created_at->diffForHumans()); ?></span>
                    </div>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($conversation->type === 'group'): ?>
                        <div class="flex justify-between">
                            <span class="text-neutral-600 dark:text-neutral-400"><?php echo e(__('chat.members')); ?></span>
                            <span class="font-medium text-neutral-900 dark:text-white"><?php echo e($conversation->participants()->count()); ?></span>
                        </div>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                </div>
            </div>
            ...
            <div class="border-t border-neutral-200 dark:border-neutral-800 pt-6">
                <button class="flex items-center gap-3 p-3 rounded-lg hover:bg-red-50 dark:hover:bg-red-900/20 transition-colors w-full text-left text-red-600 dark:text-red-400">
                    ...
                    <span class="text-sm font-medium"><?php echo e(__('chat.delete_conversation')); ?></span>
                </button>
            </div>
        </div>
    </div>
    ...
    <!-- Messages -->
    <div class="chat-messages" id="chat-messages-<?php echo e($conversation->id); ?>">
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $messages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $message): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="chat-message <?php echo e($message->user_id === auth()->id() ? 'sent' : 'received'); ?>">
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($message->user_id !== auth()->id()): ?>
                    <img src="<?php echo e(\App\Helpers\AvatarHelper::getUserAvatarUrl($message->user, 72)); ?>" 
                ...
                <div class="chat-message-content">
                    <!-- Reply indicator -->
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($message->reply_to): ?>
                        <?php
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($replyTo): ?>
                            <div class="chat-message-reply">
                                <strong><?php echo e($replyTo->user->name); ?></strong>
                                <p><?php echo e(Str::limit($replyTo->body, 50)); ?></p>
                            </div>
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    ...
                    <div class="chat-message-bubble">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($message->type === 'text'): ?>
                            <p class="chat-message-text"><?php echo e($message->body); ?></p>
                        <?php elseif($message->type === 'image'): ?>
                            <img src="<?php echo e($message->metadata['url'] ?? ''); ?>" 
                                 alt="Image" 
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($message->body): ?>
                                <p class="chat-message-text mt-2"><?php echo e($message->body); ?></p>
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        <?php elseif($message->type === 'file'): ?>
                            <div class="chat-message-file">
                                ...
                                <div class="chat-message-file-info">
                                    <p class="chat-message-file-name"><?php echo e($message->metadata['filename'] ?? 'File'); ?></p>
                                    <p class="chat-message-file-size"><?php echo e($message->metadata['size'] ?? ''); ?></p>
                                </div>
                            </div>
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    </div>
                    ...
                    <div class="chat-message-meta">
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($message->user_id === auth()->id()): ?>
                            <div class="flex items-center gap-0.5" title="<?php echo e($message->status === 'read' ? __('chat.read') : ($message->status === 'delivered' ? __('chat.delivered') : __('chat.sent'))); ?>">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($message->isRead()): ?>
                                ...
                                <?php elseif($message->isDelivered()): ?>
        ...
        <div x-show="typingUsers.length > 0" 
            ...
            <img src="<?php echo e(\App\Helpers\AvatarHelper::getUserAvatarUrl($conversation->getOtherParticipant(auth()->user()), 48)); ?>" 
                 alt="Typing" 
                 class="chat-message-avatar">
            <div class="chat-message-content">
                <div class="chat-message-bubble">
                    <div class="flex items-center gap-1 px-2 py-1">
                        <span class="text-sm text-neutral-600 dark:text-neutral-400">
                            ...
                            <span><?php echo e(__('chat.typing')); ?></span>
                        </span>
    ...
    <div class="chat-input-container">
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($replyTo): ?>
            <div class="chat-input-reply">
                <div>
                    <strong><?php echo e(__('chat.replying_to')); ?> <?php echo e($replyTo->user->name); ?></strong>
                    <p class="text-sm"><?php echo e(Str::limit($replyTo->body, 50)); ?></p>
                </div>
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($attachment): ?>
            <div class="chat-input-attachment-preview">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(str_starts_with($attachment->getMimeType(), 'image/')): ?>
                    <img src="<?php echo e($attachment->temporaryUrl()); ?>" alt="Preview">
                <?php else: ?>
                    <div class="p-4 bg-neutral-100 dark:bg-neutral-800 rounded-lg">
                        <p class="font-medium"><?php echo e($attachment->getClientOriginalName()); ?></p>
                        <p class="text-sm text-neutral-500"><?php echo e(number_format($attachment->getSize() / 1024, 2)); ?> KB</p>
                    </div>
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        ...
        <div class="chat-input-wrapper">
            ...
            <div class="chat-input-actions">
                <label class="chat-input-btn" title="<?php echo e(__('chat.attach_file')); ?>">
            ...
            <textarea 
                ...
                x-on:input.debounce.500ms="
                    if ($event.target.value.trim().length > 0) {
                        fetch('<?php echo e(route('api.chat.typing.start')); ?>', {
                            method: 'POST',
                            headers: {
                ...
                "
                x-on:keyup.enter="
                    fetch('<?php echo e(route('api.chat.typing.stop')); ?>', {
                        method: 'POST',
                        headers: {
                            'Content-Type': 'application/json',
                            'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>'
                ...
                placeholder="<?php echo e(__('chat.type_message')); ?>"
                rows="1"></textarea>
    ...
    <?php
        $__scriptKey = '559186437-0';
        ob_start();
    ?>
<script>
    const chatContainerId = 'chat-messages-<?php echo e($conversation->id); ?>';
    ...
    ?>
<?php /**PATH C:\xampp\htdocs\slamin_v2\resources\views/livewire/chat/chat-show.blade.php ENDPATH**/ ?>