...
<div x-data="{ 
    ...
    showTooltip: false,
    likers: [],
    totalLikes: <?php echo e($likesCount); ?>,
    remainingLikes: 0,
    loadingLikers: false,
    loadError: false,
    tooltipTimeout: null,
    ...
    async loadLikers() {
        ...
        try {
            const url = `/api/like/likers?id=<?php echo e($itemId); ?>&type=<?php echo e($itemType); ?>`;
    ...
    toggleLike() {
     ...
     <?php echo e($attributes->merge(['class' => 'inline-flex items-center gap-1 relative'])); ?>>
    <button type="button"
            @click="toggleLike()"
        ...
        <span class="font-medium <?php echo e($textSize); ?>" 
              ...
              x-text="likesCount"><?php echo e($likesCount); ?></span>
    </button>
...
<?php /**PATH C:\xampp\htdocs\slamin_v2\resources\views/components/like-button.blade.php ENDPATH**/ ?>