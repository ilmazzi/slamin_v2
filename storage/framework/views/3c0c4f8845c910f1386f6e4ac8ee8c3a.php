...
<nav class="fixed top-0 left-0 right-0 z-50 transition-all duration-300 bg-white/95 dark:bg-neutral-900/95 backdrop-blur-md shadow-lg"
    ...
    <div class="max-w-7xl mx-auto px-4 md:px-6 lg:px-8">
        ...
        <div x-show="isOpen" 
            ...
            <a href="<?php echo e(route('gallery.index')); ?>" class="block px-4 py-2 rounded-lg hover:bg-primary-50 dark:hover:bg-primary-900/20 transition-colors">Galleria</a>
...
<?php /**PATH C:\xampp\htdocs\slamin_v2\resources\views/components/layouts/navigation-modern.blade.php ENDPATH**/ ?>