                    ...
                    <div class="bg-white dark:bg-neutral-800 rounded-xl shadow-lg p-6 sticky top-6">
                        ...
                        <div class="space-y-3 mb-4">
                            <div class="flex justify-between">
                                ...
                                <span class="font-semibold text-neutral-900 dark:text-white">€{{ number_format($commissionData['translator_amount'], 2) }}</span>
                            </div>
                            <div class="flex justify-between text-sm">
                                <span class="text-neutral-600 dark:text-neutral-400">Commissione servizio ({{ ($commissionData['commission_rate'] * 100) }}%):</span>
                                <span class="text-neutral-700 dark:text-neutral-300">€{{ number_format($commissionData['platform_commission'], 2) }}</span>
                            </div>
                            <div class="flex justify-between text-sm">
                                <span class="text-neutral-600 dark:text-neutral-400">Costi di elaborazione:</span>
                                <span class="text-neutral-700 dark:text-neutral-300">€{{ number_format($commissionData['stripe_commission'], 2) }}</span>
                            </div>
                        </div>
                        ...
                        <div class="pt-4 border-t-2 border-neutral-300 dark:border-neutral-600">
                            <div class="flex justify-between items-center mb-2">
                                ...
                                <span class="text-2xl font-black text-primary-600 dark:text-primary-400">€{{ number_format($commissionData['total_amount'], 2) }}</span>
                            </div>
                            <p class="text-xs text-neutral-500 dark:text-neutral-400">
                                Il traduttore riceverà esattamente €{{ number_format($commissionData['translator_amount'], 2) }} come concordato
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="lg:col-span-2">
                    <div class="bg-white dark:bg-neutral-800 rounded-xl shadow-lg p-6">
                        ...
                        @if($paymentMethod === 'stripe')
                            {{-- Stripe Payment Form (include PayPal) --}}
                            <div id="stripe-payment-form">
                                ...
                                <button type="button" 
                                    ...
                                    <span wire:loading.remove>
                                        💳 Paga €{{ number_format($commissionData['total_amount'], 2) }}
                                    </span>
                                    <span wire:loading>
