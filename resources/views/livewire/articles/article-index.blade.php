<div class="min-h-screen">
    ...
    <section class="relative pt-16 pb-12 md:pb-20 overflow-hidden articles-hero-bg">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            @if(!$showAllArticles && !$search && !$selectedCategory && !empty($layoutArticles))
                ...
                <div class="text-center mb-12">
                    <button wire:click="toggleShowAll" class="px-6 py-3 bg-primary-600 hover:bg-primary-700 dark:bg-neutral-800 dark:hover:bg-neutral-700 text-white rounded-lg shadow-lg transition-all duration-200">
            ...
            @if($showAllArticles || $search || $selectedCategory)
                <div class="mb-8 flex items-center justify-between">
                    ...
                    @if($showAllArticles && !$search && !$selectedCategory)
                        <button wire:click="toggleShowAll" class="px-4 py-2 bg-primary-600 hover:bg-primary-700 dark:bg-neutral-800 dark:hover:bg-neutral-700 text-white rounded-lg transition-all duration-200">
                            <svg class="w-5 h-5 inline-block mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
