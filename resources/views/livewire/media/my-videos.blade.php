            ...
            <div class="flex flex-col items-center gap-6 md:flex-row md:justify-center md:gap-12">
                ...
                <div class="media-page-film-card">
                    ...
                    <div class="media-page-film-frame">
                        ...
                        <div class="media-page-film-text">My Videos</div>
                    </div>
                </div>
                ...
                <div class="text-center md:text-left">
                    ...
                    <p class="text-xl md:text-2xl text-white/80 mt-4 font-medium">
                        {{ __('media.my_videos_description') }}
                    </p>
                    
                    <div class="mt-8 flex flex-col sm:flex-row gap-4 justify-center md:justify-start">
                        @can('upload.video')
                            <a href="{{ route('media.upload.video') }}" class="btn-primary-lg">
                                <i class="ph-duotone ph-upload-simple me-2"></i>
                                {{ __('media.upload_video') }}
                            </a>
                        @endcan
                        <a href="{{ route('media.index') }}" class="btn-secondary-lg">
            ...
            <div class="mb-8 flex flex-col md:flex-row gap-4 items-center justify-between">
                <div class="flex-1 max-w-md w-full">
                    <div class="relative">
                        <input type="text"
                               ...
                               placeholder="{{ __('media.search_my_videos') }}"
                ...
                <div class="flex items-center gap-2 bg-white dark:bg-neutral-800 p-1 rounded-full shadow-lg">
                    <button wire:click="$set('filter', 'all')"
                            class="px-4 py-2 rounded-full font-black text-sm transition-all {{ $filter === 'all' ? 'bg-primary-600 text-white shadow-lg' : 'text-neutral-600 dark:text-neutral-400' }}">
                        {{ __('media.all') }}
                    </button>
                    <button wire:click="$set('filter', 'approved')"
                            class="px-4 py-2 rounded-full font-black text-sm transition-all {{ $filter === 'approved' ? 'bg-green-600 text-white shadow-lg' : 'text-neutral-600 dark:text-neutral-400' }}">
                        {{ __('media.approved') }}
                    </button>
                    <button wire:click="$set('filter', 'pending')"
                            class="px-4 py-2 rounded-full font-black text-sm transition-all {{ $filter === 'pending' ? 'bg-yellow-600 text-white shadow-lg' : 'text-neutral-600 dark:text-neutral-400' }}">
                        {{ __('media.pending') }}
                    </button>
                    <button wire:click="$set('filter', 'rejected')"
                            class="px-4 py-2 rounded-full font-black text-sm transition-all {{ $filter === 'rejected' ? 'bg-red-600 text-white shadow-lg' : 'text-neutral-600 dark:text-neutral-400' }}">
                        {{ __('media.rejected') }}
                    </button>
                </div>
            </div>
