        ...
        <div class="space-y-3">
            ...
            @empty
                <div class="bg-white dark:bg-neutral-800 rounded-2xl shadow-lg p-12 text-center">
                    ...
                    <h3 class="text-2xl font-bold text-neutral-900 dark:text-white mb-2">Nessuna guida trovata</h3>
                    <p class="text-neutral-600 dark:text-neutral-400">
                        @if(!empty($search))
                            Prova a modificare i criteri di ricerca
                        @else
                            Non ci sono guide disponibili al momento
                        @endif
                    </p>
                </div>
            @endforelse
