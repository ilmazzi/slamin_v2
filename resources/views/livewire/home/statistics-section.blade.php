<div>
    <div class="max-w-7xl mx-auto px-4 md:px-6 lg:px-8">
        <div class="bg-white/95 dark:bg-neutral-900/95 backdrop-blur-xl rounded-3xl shadow-2xl p-8 md:p-12 border border-primary-100 dark:border-primary-900">
            <div class="grid grid-cols-2 md:grid-cols-4 gap-8 md:gap-12">
                ...
                <div class="text-center group"
                    ...
                    <div class="text-sm md:text-base text-neutral-600 dark:text-neutral-400 font-medium">Poeti</div>
                </div>
                ...
                <div class="text-center group"
                    ...
                    <div class="text-sm md:text-base text-neutral-600 dark:text-neutral-400 font-medium">Video</div>
                </div>
                ...
                <div class="text-center group"
                    ...
                    <div class="text-sm md:text-base text-neutral-600 dark:text-neutral-400 font-medium">Eventi</div>
                </div>
                ...
                <div class="text-center group"
                    ...
                    <div class="text-sm md:text-base text-neutral-600 dark:text-neutral-400 font-medium">Visualizzazioni</div>
                </div>
            </div>
        </div>
    </div>
