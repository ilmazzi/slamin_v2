<div>
    ...
    @if ($completedEvents && $completedEvents->count() > 0)
        ...
        <div x-ref="scrollContainer" class="flex gap-6 overflow-x-auto pb-16 pt-12 px-8 md:px-12 scrollbar-hide"
            ...
            @foreach($completedEvents->take(6) as $i => $event)
            <?php
                // Random ticket tilt
                $tilt = rand(-3, 3);
                    ...
                    <div class="ticket-content">
                        ...
                        <div class="ticket-details">
                            ...
                            <div class="ticket-detail-item">
                                ...
                                <div class="ticket-detail-value">{{ $event->end_datetime->locale('it')->isoFormat('D MMM YYYY') }}</div>
                            </div>
                            @endif
