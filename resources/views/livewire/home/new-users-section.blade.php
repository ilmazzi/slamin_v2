<div>
    ...
    <div class="max-w-[90rem] mx-auto px-4 md:px-6 lg:px-8">
        ...
        <div class="relative" x-data="{ 
            ...
            <div class="md:hidden absolute right-0 top-0 bottom-0 w-24 bg-gradient-to-l from-neutral-100 dark:from-neutral-800 to-transparent pointer-events-none z-10"></div>
