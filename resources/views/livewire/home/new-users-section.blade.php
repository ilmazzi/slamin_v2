        ...
        <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-8 gap-6">
            ...
            <div class="group text-center"
                ...
                <div class="relative mb-3">
                    <div class="w-20 h-20 mx-auto rounded-full overflow-hidden ring-4 ring-primary-100 dark:ring-primary-900 group-hover:ring-primary-400 transition-all shadow-lg">
                ...
                <button class="mt-2 w-full px-3 py-1.5 text-xs font-semibold text-primary-600 hover:text-white border border-primary-600 hover:bg-primary-600 rounded-full transition-all opacity-0 group-hover:opacity-100">
                    Segui
                </button>
            </div>
            @endforeach
