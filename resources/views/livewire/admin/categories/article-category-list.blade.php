    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="mb-8">
            <div class="flex items-center justify-between">
                <div>
                    <h1 class="text-3xl font-bold text-neutral-900 dark:text-white">Categorie Articoli</h1>
                    <p class="mt-2 text-neutral-600 dark:text-neutral-400">Gestisci le categorie degli articoli del sito</p>
                </div>
                ...
                <tbody class="bg-white dark:bg-neutral-800 divide-y divide-neutral-200 dark:divide-neutral-700">
                    @foreach ($categories as $category)
                        <tr>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <span class="text-sm text-neutral-900 dark:text-white">{{ $category->articles()->count() }}</span>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap">
