                            ...
                            <tbody class="bg-white dark:bg-neutral-800 divide-y divide-neutral-200 dark:divide-neutral-700">
                                @foreach($badges as $badge)
                                    <tr class="hover:bg-neutral-50 dark:hover:bg-neutral-700/50 transition-colors">
                                        ...
                                        <td class="px-4 py-4">
                                            <div class="font-semibold text-neutral-900 dark:text-white">{{ $badge->translated_name }}</div>
                                            @if($badge->translated_description)
                                                <div class="text-sm text-neutral-500 dark:text-neutral-400 mt-1">
                                                    {{ Str::limit($badge->translated_description, 50) }}
                                                </div>
                                            @endif
                                        </td>
                                        <td class="px-4 py-4 whitespace-nowrap">
                ...
                <div class="relative inline-block align-bottom bg-white dark:bg-neutral-800 rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-2xl sm:w-full z-50"
                    ...
                    <form wire:submit.prevent="save" class="px-6 py-4">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div class="md:col-span-2 mt-6 pt-6 border-t border-neutral-200 dark:border-neutral-700" x-data="{ activeTab: 'en' }">
                                <h4 class="text-md font-semibold text-neutral-900 dark:text-white mb-4">
                                    🌍 {{ __('Traduzioni (altre lingue)') }}
                                </h4>
                                <p class="text-sm text-neutral-600 dark:text-neutral-400 mb-4">
                                    I campi sopra sono in italiano (lingua predefinita). Qui puoi aggiungere le traduzioni in altre lingue.
                                </p>
                                
                                {{-- Language Tabs (exclude Italian) --}}
                                ...
                                {{-- Translation Fields (exclude Italian) --}}
                                @foreach($availableLocales as $locale)
                                    @if($locale !== 'it')
