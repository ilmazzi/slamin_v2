<div class="flex items-center {{ $layout === 'vertical' ? 'flex-col' : 'gap-6' }}">
    ...
    <button 
        ...
        class="flex items-center gap-2 text-neutral-600 dark:text-neutral-400 hover:text-red-600 dark:hover:text-red-500 transition-colors group {{ $layout === 'vertical' ? 'flex-col' : '' }}"
        @class([
    ...
    <button 
        ...
        class="flex items-center gap-2 text-neutral-600 dark:text-neutral-400 hover:text-primary-600 dark:hover:text-primary-500 transition-colors group {{ $layout === 'vertical' ? 'flex-col' : '' }}">
