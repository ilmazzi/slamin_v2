                ...
                <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
                    ...
                    <div class="flex-1">
                        ...
                        <div class="mt-4 flex flex-wrap gap-2 text-xs">
                            <a href="{{ route('cookies') }}" target="_blank" class="text-primary-600 hover:text-primary-700 dark:text-primary-400 font-semibold hover:underline">
                                {{ __('cookies.learn_more') }}
                            </a>
                            <span class="text-neutral-400">•</span>
                            <a href="{{ route('privacy') }}" target="_blank" class="text-primary-600 hover:text-primary-700 dark:text-primary-400 font-semibold hover:underline">
                ...
                <div class="space-y-4">
                    ...
                    <div class="flex items-start justify-between p-4 bg-white dark:bg-neutral-800 rounded-lg border border-neutral-200 dark:border-neutral-700">
                        <div class="flex-1 pr-4">
                            ...
                            <p class="text-xs text-neutral-600 dark:text-neutral-400 leading-relaxed">
                                {{ __('cookies.necessary_description') }}
                            </p>
                        </div>
                    ...
                    <div class="flex items-start justify-between p-4 bg-white dark:bg-neutral-800 rounded-lg border border-neutral-200 dark:border-neutral-700">
                        <div class="flex-1 pr-4">
                            ...
                            <p class="text-xs text-neutral-600 dark:text-neutral-400 leading-relaxed">
                                {{ __('cookies.analytics_description') }}
                            </p>
                        </div>
                        <div class="flex-shrink-0">
                    ...
                    <div class="flex items-start justify-between p-4 bg-white dark:bg-neutral-800 rounded-lg border border-neutral-200 dark:border-neutral-700">
                        <div class="flex-1 pr-4">
                            ...
                            <p class="text-xs text-neutral-600 dark:text-neutral-400 leading-relaxed">
                                {{ __('cookies.marketing_description') }}
                            </p>
                        </div>
                        <div class="flex-shrink-0">
