                    ...
                    <a href="{{ route('gigs.index') }}" 
                       ...
                       :class="collapsed && 'justify-center'">
                        ...
                        <span x-show="!collapsed" 
                              ...
                              x-transition:leave-start="opacity-100 translate-x-0"
                              x-transition:leave-end="opacity-0 -translate-x-4"
                              class="text-sm font-medium">{{ __('common.gigs') }}</span>
                    </a>
                    <div x-show="tooltip && collapsed" x-transition:enter="transition ease-out duration-300" x-transition:enter-start="opacity-0 translate-x-4 scale-95" x-transition:enter-end="opacity-100 translate-x-0 scale-100" x-transition:leave="transition ease-in duration-200" x-transition:leave-start="opacity-100 translate-x-0 scale-100" x-transition:leave-end="opacity-0 translate-x-4 scale-95" class="fixed px-5 py-2.5 bg-gradient-to-r from-primary-600 to-primary-500 text-white text-sm font-semibold rounded-xl shadow-2xl whitespace-nowrap z-[9999]" :style="`left: 88px; top: ${$refs.gigsLink.getBoundingClientRect().top}px;`" style="box-shadow: 0 10px 40px -10px rgba(5, 150, 105, 0.5);"><span class="relative z-10">{{ __('common.gigs') }}</span><div class="absolute inset-0 bg-primary-400/20 rounded-xl blur-xl -z-10"></div><div class="absolute right-full top-1/2 -translate-y-1/2 mr-0.5"><div class="w-0 h-0 border-t-[7px] border-t-transparent border-b-[7px] border-b-transparent border-r-[8px] border-r-primary-600"></div></div></div>
                </li>
                @endauth
                    ...
                    <a href="{{ route('poems.index') }}" 
                       ...
                       :class="collapsed && 'justify-center'">
                        ...
                        <span x-show="!collapsed" 
                              ...
                              x-transition:leave-start="opacity-100 translate-x-0"
                              x-transition:leave-end="opacity-0 -translate-x-4"
                              class="text-sm font-medium">{{ __('common.poems') }}</span>
                    </a>
                    <div x-show="tooltip && collapsed" x-transition:enter="transition ease-out duration-300" x-transition:enter-start="opacity-0 translate-x-4 scale-95" x-transition:enter-end="opacity-100 translate-x-0 scale-100" x-transition:leave="transition ease-in duration-200" x-transition:leave-start="opacity-100 translate-x-0 scale-100" x-transition:leave-end="opacity-0 translate-x-4 scale-95" class="fixed px-5 py-2.5 bg-gradient-to-r from-primary-600 to-primary-500 text-white text-sm font-semibold rounded-xl shadow-2xl whitespace-nowrap z-[9999]" :style="`left: 88px; top: ${$refs.poesieLink.getBoundingClientRect().top}px;`" style="box-shadow: 0 10px 40px -10px rgba(5, 150, 105, 0.5);"><span class="relative z-10">{{ __('common.poems') }}</span><div class="absolute inset-0 bg-primary-400/20 rounded-xl blur-xl -z-10"></div><div class="absolute right-full top-1/2 -translate-y-1/2 mr-0.5"><div class="w-0 h-0 border-t-[7px] border-t-transparent border-b-[7px] border-b-transparent border-r-[8px] border-r-primary-600"></div></div></div>
                </li>
                    ...
                    <a href="{{ route('articles.index') }}" 
                       ...
                       :class="collapsed && 'justify-center'">
                        ...
                        <span x-show="!collapsed" 
                              ...
                              x-transition:leave-start="opacity-100 translate-x-0"
                              x-transition:leave-end="opacity-0 -translate-x-4"
                              class="text-sm font-medium">{{ __('common.articles') }}</span>
                    </a>
                    <div x-show="tooltip && collapsed" x-transition:enter="transition ease-out duration-300" x-transition:enter-start="opacity-0 translate-x-4 scale-95" x-transition:enter-end="opacity-100 translate-x-0 scale-100" x-transition:leave="transition ease-in duration-200" x-transition:leave-start="opacity-100 translate-x-0 scale-100" x-transition:leave-end="opacity-0 translate-x-4 scale-95" class="fixed px-5 py-2.5 bg-gradient-to-r from-primary-600 to-primary-500 text-white text-sm font-semibold rounded-xl shadow-2xl whitespace-nowrap z-[9999]" :style="`left: 88px; top: ${$refs.articoliLink.getBoundingClientRect().top}px;`" style="box-shadow: 0 10px 40px -10px rgba(5, 150, 105, 0.5);"><span class="relative z-10">{{ __('common.articles') }}</span><div class="absolute inset-0 bg-primary-400/20 rounded-xl blur-xl -z-10"></div><div class="absolute right-full top-1/2 -translate-y-1/2 mr-0.5"><div class="w-0 h-0 border-t-[7px] border-t-transparent border-b-[7px] border-b-transparent border-r-[8px] border-r-primary-600"></div></div></div>
                </li>
                    ...
                    <a href="{{ route('media.index') }}" 
                       ...
                       :class="collapsed && 'justify-center'">
                        ...
                        <span x-show="!collapsed" 
                              ...
                              x-transition:leave-start="opacity-100 translate-x-0"
                              x-transition:leave-end="opacity-0 -translate-x-4"
                              class="text-sm font-medium">{{ __('common.media') }}</span>
                    </a>
                    <div x-show="tooltip && collapsed" x-transition:enter="transition ease-out duration-300" x-transition:enter-start="opacity-0 translate-x-4 scale-95" x-transition:enter-end="opacity-100 translate-x-0 scale-100" x-transition:leave="transition ease-in duration-200" x-transition:leave-start="opacity-100 translate-x-0 scale-100" x-transition:leave-end="opacity-0 translate-x-4 scale-95" class="fixed px-5 py-2.5 bg-gradient-to-r from-primary-600 to-primary-500 text-white text-sm font-semibold rounded-xl shadow-2xl whitespace-nowrap z-[9999]" :style="`left: 88px; top: ${$refs.mediaLink.getBoundingClientRect().top}px;`" style="box-shadow: 0 10px 40px -10px rgba(5, 150, 105, 0.5);"><span class="relative z-10">{{ __('common.media') }}</span><div class="absolute inset-0 bg-primary-400/20 rounded-xl blur-xl -z-10"></div><div class="absolute right-full top-1/2 -translate-y-1/2 mr-0.5"><div class="w-0 h-0 border-t-[7px] border-t-transparent border-b-[7px] border-b-transparent border-r-[8px] border-r-primary-600"></div></div></div>
                </li>
                    ...
                    <a href="{{ route('forum.index') }}" 
                       ...
                       :class="collapsed && 'justify-center'">
                        ...
                        <span x-show="!collapsed" 
                              ...
                              x-transition:leave-start="opacity-100 translate-x-0"
                              x-transition:leave-end="opacity-0 -translate-x-4"
                              class="text-sm font-medium">{{ __('common.forum') }}</span>
                    </a>
                    ...
                    <a href="{{ route('groups.index') }}" 
                       ...
                       :class="collapsed && 'justify-center'">
                        ...
                        <span x-show="!collapsed" 
                              ...
                              x-transition:leave-start="opacity-100 translate-x-0"
                              x-transition:leave-end="opacity-0 -translate-x-4"
                              class="text-sm font-medium">{{ __('common.users_groups') }}</span>
                    </a>
        ...
        <div class="p-3 border-t border-neutral-200 dark:border-neutral-800">
            ...
            <button @click="collapsed = !collapsed"
                ...
                <span x-show="!collapsed" 
                      ...
                      x-transition:leave-start="opacity-100 translate-x-0"
                      x-transition:leave-end="opacity-0 -translate-x-4"
                      class="text-sm font-medium">{{ __('common.collapse') }}</span>
            </button>
        </div>
    </div>
</aside>
    ...
    <div class="flex flex-col h-full">
                ...
                <li>
                    <a href="{{ route('poems.index') }}" 
                       ...
                       class="flex items-center gap-3 px-3 py-2.5 rounded-lg hover:bg-primary-50 dark:hover:bg-primary-900/20 text-neutral-700 dark:text-neutral-300 hover:text-primary-600 transition-all group">
                        ...
                        <span class="text-sm font-medium">{{ __('common.poems') }}</span>
                    </a>
                </li>
                ...
                <li>
                    <a href="{{ route('articles.index') }}" 
                       ...
                       class="flex items-center gap-3 px-3 py-2.5 rounded-lg hover:bg-primary-50 dark:hover:bg-primary-900/20 text-neutral-700 dark:text-neutral-300 hover:text-primary-600 transition-all group">
                        ...
                        <span class="text-sm font-medium">{{ __('common.articles') }}</span>
                    </a>
                </li>
                ...
                <li>
                    <a href="{{ route('media.index') }}" 
                       ...
                       class="flex items-center gap-3 px-3 py-2.5 rounded-lg hover:bg-primary-50 dark:hover:bg-primary-900/20 text-neutral-700 dark:text-neutral-300 hover:text-primary-600 transition-all group">
                        ...
                        <span class="text-sm font-medium">{{ __('common.media') }}</span>
                    </a>
                </li>
                ...
                <li>
                    <a href="{{ route('forum.index') }}" 
                       ...
                       class="flex items-center gap-3 px-3 py-2.5 rounded-lg hover:bg-orange-50 dark:hover:bg-orange-900/20 text-neutral-700 dark:text-neutral-300 hover:text-orange-600 transition-all group">
                        ...
                        <span class="text-sm font-medium">{{ __('common.forum') }}</span>
                    </a>
                </li>
        ...
        <div class="p-3 border-t border-neutral-200 dark:border-neutral-800">
            <button @click="mobileOpen = false"
                ...
                <span class="text-sm font-medium">{{ __('common.close_menu') }}</span>
            </button>
        </div>
    </div>
</aside>
