<aside class="fixed left-0 top-16 bottom-0 bg-white dark:bg-neutral-900 border-r border-neutral-200 dark:border-neutral-800 transition-all duration-300 z-40"
       x-data="{ 
    ...
    <div x-show="mobileOpen"
         ...
         class="lg:hidden fixed left-0 top-16 bottom-0 w-64 bg-white dark:bg-neutral-900 border-r border-neutral-200 dark:border-neutral-800 z-40">
        <!-- Same content as desktop sidebar (reuse above nav) -->
    </div>
</aside>
