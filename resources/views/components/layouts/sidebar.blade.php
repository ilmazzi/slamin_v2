    ...
    <div class="flex flex-col h-full overflow-visible">
            ...
            <ul class="space-y-1">
                ...
                <li class="relative" x-data="{ tooltip: false }" x-ref="homeItem">
                    <a href="{{ route('home') }}" 
                       ...
                       x-ref="homeLink"
                       class="flex items-center gap-3 px-3 py-2.5 rounded-lg hover:bg-gradient-to-r hover:from-primary-50 hover:to-primary-100 dark:hover:from-primary-900/20 dark:hover:to-primary-800/20 text-neutral-700 dark:text-neutral-300 hover:text-primary-600 dark:hover:text-primary-400 transition-all duration-300 group"
                       :class="collapsed && 'justify-center'">
                ...
                <li class="relative" x-data="{ tooltip: false }">
                    <a href="#" 
                       ...
                       :class="collapsed && 'justify-center'">
                        ...
                        <span x-show="!collapsed" 
                              x-transition:enter="transition ease-out duration-300 delay-[450ms]"
                              x-transition:enter-start="opacity-0 -translate-x-4"
                              x-transition:enter-end="opacity-100 translate-x-0"
                              x-transition:leave="transition ease-in duration-200"
                              x-transition:leave-start="opacity-100 translate-x-0"
        ...
        <div class="p-3 border-t border-neutral-200 dark:border-neutral-800">
            ...
            <button @click="collapsed = !collapsed"
                    class="w-full flex items-center gap-3 px-3 py-2.5 rounded-lg hover:bg-gradient-to-r hover:from-neutral-100 hover:to-neutral-200 dark:hover:from-neutral-800 dark:hover:to-neutral-700 text-neutral-600 dark:text-neutral-400 hover:text-neutral-900 dark:hover:text-neutral-200 transition-all duration-300 group"
                    :class="collapsed && 'justify-center'">
