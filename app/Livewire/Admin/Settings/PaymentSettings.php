...
class PaymentSettings extends Component
{
    ...
    {
        try {
            // Rimuovi tutte le impostazioni di pagamento
            SystemSetting::where('group', 'payment')->delete();
            
            // Reinizializza le impostazioni di default
            SystemSetting::initializeDefaults();
            
            $this->loadSettings();
            session()->flash('message', __('admin.settings.payment.reset_success'));
        } catch (\Exception $e) {
            session()->flash('error', __('admin.settings.payment.reset_error') . ': ' . $e->getMessage());
        }
    }
