...
class ContentRemovedNotification extends Notification implements ShouldQueue
{
     ...
     */
    public function __construct($contentType, $contentTitle, $reason, $notes = null)
    {
    ...
    public function toArray(object $notifiable): array
    {
        ...
        return [
            ...
            'reason' => $this->reason,
            'notes' => $this->notes,
            'title' => __('notifications.content_removed_title'),
            'message' => __('notifications.content_removed_message', [
