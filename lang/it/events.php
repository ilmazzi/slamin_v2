...
return [
    ...
    'free' => 'Gratis',
    'past_events' => 'Passati',
    'today_events' => 'Eventi di Oggi',
    'today_events_description' => 'Gli eventi che si svolgono oggi',
    'timeline_upcoming_description' => 'Scorri per vedere gli eventi futuri, dal più imminente al più lontano',
    'timeline_past_description' => 'Scorri per vedere gli eventi passati, dal più recente al più vecchio',
    'scroll_to_see_more' => 'Scorri per vedere altro',
    'no_past_events' => 'Nessun evento passato',
    'no_past_events_description' => 'Non ci sono ancora eventi conclusi',
    ...
    'scoring' => [
        ...
        'cannot_create_round_participants_without_scores' => 'Non puoi creare un nuovo turno. Ci sono :count partecipanti che non hanno ricevuto un punteggio nel turno precedente.',
        'select_participants_for_next_round' => 'Seleziona Partecipanti per il Turno Successivo',
        'select_participants_who_advance' => 'Seleziona i partecipanti che accedono al turno successivo. Puoi deselezionare chi vuoi eliminare.',
        'select_at_least_one_participant' => 'Devi selezionare almeno un partecipante per il turno successivo.',
        'continue' => 'Continua',
        'close_event_calculate_and_assign_badges' => 'Chiudi evento, calcola risultati e assegna badge',
        ...
        'votes' => 'voti',
        'all_scores' => 'Tutti i Voti',
        'no_scores_yet' => 'Nessun voto ancora inserito',
        'multiple_judges_can_vote' => 'Più giudici possono inserire voti per ogni partecipante.',
        'your_vote_will_be_saved' => 'Il tuo voto verrà salvato e sarà visibile insieme agli altri.',
        'green_badge_your_vote' => 'Badge verde = il tuo voto',
        'all_scores_visible' => 'Tutti i voti sono visibili',
        'score_saved_successfully' => 'Voto salvato con successo!',
        'scores_saved_successfully' => ':count voti salvati con successo per :participant!',
        'judges_count' => 'Numero Giudici',
        'judges' => 'Giudici',
        'judge' => 'Giudice',
        'judges_scores' => 'Voti dei Giudici',
        'enter_all_judges_scores' => 'Inserisci tutti i voti dei giudici per ogni partecipante.',
        'scores_will_be_calculated_automatically' => 'I punteggi verranno calcolati automaticamente in base alla modalità selezionata.',
        'green_button_all_scores_saved' => 'Pulsante verde = tutti i voti salvati',
        'all_saved' => 'Tutti salvati',
        'save_scores' => 'Salva Voti',
        'saving' => 'Salvataggio',
        'calculated_results' => 'Risultati Calcolati',
        'final_score' => 'Punteggio Finale',
        'scoring_mode' => 'Modalità di Calcolo',
        'number_of_judges_help' => 'Numero di giudici che voteranno in questo turno',
        'enter_all_judges_scores_for_each_participant' => 'Inserisci tutti i voti dei giudici per ogni partecipante.',
        'saved' => 'Salvato',
        'cannot_modify_scores_event_completed' => 'Non puoi modificare i punteggi di un evento completato.',
        'cannot_modify_rounds_event_completed' => 'Non puoi modificare i turni di un evento completato.',
        'cannot_delete_rounds_event_completed' => 'Non puoi eliminare i turni di un evento completato.',
        'no_rounds_configured' => 'Nessun turno configurato.',
        'single_round' => 'Turno Singolo',
        'saved' => 'Salvato',
        'deleted' => 'Eliminato',
