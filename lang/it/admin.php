...
return [
    ...
    'sections' => [
        ...
        'poem_categories' => [
            'title' => 'Categorie Poesie',
            'description' => 'Gestisci le categorie delle poesie',
        ],
        'carousels' => [
            'title' => 'Gestione Carousel',
            'description' => 'Gestisci il carousel della homepage',
            'add' => 'Aggiungi Carousel',
            'edit' => 'Modifica Carousel',
            'create' => 'Crea Carousel',
            'search_placeholder' => 'Cerca per titolo o descrizione...',
            'filter_type' => 'Tipo',
            'filter_type_all' => 'Tutti',
            'filter_type_upload' => 'Upload',
            'filter_type_content' => 'Contenuto',
            'filter_status' => 'Stato',
            'filter_status_all' => 'Tutti',
            'filter_status_active' => 'Attivi',
            'filter_status_inactive' => 'Inattivi',
            'no_carousels' => 'Nessun carousel trovato',
            'form' => [
                'content_type' => 'Tipo Contenuto',
                'content_type_upload' => 'Upload Tradizionale',
                'content_type_video' => 'Video',
                'content_type_event' => 'Evento',
                'content_type_user' => 'Utente',
                'content_type_poem' => 'Poesia',
                'content_type_article' => 'Articolo',
                'content_search' => 'Cerca Contenuto',
                'content_search_placeholder' => 'Digita per cercare...',
                'content_selected' => 'Contenuto Selezionato',
                'min_chars' => 'Inserisci almeno :min caratteri per cercare',
                ...
                'image' => 'Immagine',
                'image_current' => 'Immagine Attuale',
                'image_upload' => 'Carica Immagine',
                'use_original_image' => 'Usa immagine originale del contenuto',
                'video' => 'Video (opzionale)',
                'video_current' => 'Video Attuale',
            ...
            'messages' => [
                'created' => 'Carousel creato con successo',
                'updated' => 'Carousel aggiornato con successo',
                'deleted' => 'Carousel eliminato con successo',
                'activated' => 'Carousel attivato',
                'deactivated' => 'Carousel disattivato',
                'order_updated' => 'Ordine aggiornato',
                'added_to_carousel' => 'Contenuto aggiunto al carousel con successo',
                'content_not_found' => 'Contenuto non trovato',
            ],
            'add_to_carousel' => 'Aggiungi al Carousel',
            'confirm_add' => 'Vuoi aggiungere questo contenuto al carousel?',
        ],
        'statistics' => [
            'title' => 'Statistiche Complete',
            'description' => 'Visualizza tutte le statistiche del sistema',
        ],
        'subreddits' => [
            'title' => 'Gestione Subreddit',
            'description' => 'Gestisci i subreddit del forum',
            'add' => 'Aggiungi Subreddit',
            'edit' => 'Modifica Subreddit',
            'create' => 'Crea Subreddit',
            'search_placeholder' => 'Cerca per nome, slug o descrizione...',
            'no_subreddits' => 'Nessun subreddit trovato',
            'private' => 'Privato',
            ...
            'form' => [
                'name' => 'Nome',
                'name_placeholder' => 'Nome del subreddit',
                'slug' => 'Slug',
                'slug_placeholder' => 'slug-del-subreddit',
                'description' => 'Descrizione',
                'description_placeholder' => 'Descrizione del subreddit',
                'rules' => 'Regole',
                'rules_placeholder' => 'Regole del subreddit',
                'icon' => 'Icona',
                'color' => 'Colore',
                'banner' => 'Banner',
                'banner_current' => 'Banner attuale',
                'banner_upload' => 'Nuovo banner',
                'is_active' => 'Attivo',
                'is_private' => 'Privato',
                'save' => 'Salva',
                'cancel' => 'Annulla',
            ...
            'messages' => [
                'created' => 'Subreddit creato con successo',
                'updated' => 'Subreddit aggiornato con successo',
                'deleted' => 'Subreddit eliminato con successo',
                'activated' => 'Subreddit attivato',
                'deactivated' => 'Subreddit disattivato',
            ],
        ],
        'newsletter' => [
            'title' => 'Newsletter',
            'description' => 'Gestisci iscritti e invia newsletter',
        ],
        'settings' => [
    ...
    'statistics' => [
        'title' => 'Statistiche Complete',
        'description' => 'Visualizza tutte le statistiche del sistema in tempo reale',
        'refresh' => 'Aggiorna Statistiche',
        'refreshed' => 'Statistiche aggiornate con successo',
        'sections' => [
            'overview' => 'Panoramica',
            'users' => 'Utenti',
            'events' => 'Eventi',
