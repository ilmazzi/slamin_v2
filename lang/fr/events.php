...
return [
    ...
    'where_poetry_lives' => 'Où la poésie prend vie',
    
    // Search & Filters
    'search_placeholder' => 'Rechercher des slams de poésie, open mics, lectures...',
    ...
    'no_upcoming_events_description' => 'Il n\'y a pas d\'événements à venir pour le moment.',
    'filtered_events' => 'Événements Filtrés',
    'filtered_events_description' => ':count événement trouvé|:count événements trouvés',
    'no_filtered_events' => 'Aucun événement trouvé',
    'no_filtered_events_description' => 'Il n\'y a pas d\'événements correspondant à vos filtres. Essayez d\'ajuster vos critères de recherche.',
    'personalized_events' => 'Vos événements',
    'personalized_events_description' => 'Événements auxquels vous participez, dans votre liste de souhaits ou suivis par les personnes que vous suivez',
